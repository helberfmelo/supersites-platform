...
$requiredPaths = @(
    ...
    "apps/control-plane/app/Http/Controllers/Admin/ExecutiveReportController.php",
    ...
    "apps/control-plane/app/Models/ExecutiveReport.php",
    "apps/control-plane/app/Models/ExecutiveReportItem.php",
    ...
    "apps/control-plane/database/migrations/2026_06_27_000210_create_executive_report_tables.php",
    ...
    "apps/control-plane/database/seeders/ExecutiveReportReadinessSeeder.php",
    ...
    "apps/control-plane/resources/views/admin/reports/index.blade.php",
    "apps/control-plane/resources/views/admin/reports/print.blade.php",
    "apps/control-plane/resources/views/admin/reports/show.blade.php",
    ...
    "packages/executive-reports",
    "packages/executive-reports/package.json",
    "packages/executive-reports/tsconfig.json",
    "packages/executive-reports/src/index.ts",
    "packages/executive-reports/tests/executive-reports.test.ts",
    "packages/security",
    "packages/testing",

...
- `run-provider-growth-readiness-smoke.ps1`: runs the authenticated provider/growth readiness Laravel smoke and writes local artifacts without calling external providers or mutating production.

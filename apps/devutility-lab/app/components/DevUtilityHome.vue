...
useHead(() => ({
  ...
  title: props.xDefault ? 'DevUtility Lab' : `${copy.value.title} | DevUtility Lab`,
  meta: [
    {
      name: 'description',
...
<template>
  <main class="page-shell">
    ...
    <section class="hero" aria-labelledby="devutility-title">
      ...
      <aside class="status-panel" aria-label="DevUtility Lab status">
      ...
      <article v-for="tool in filteredTools" :key="tool.slug" class="tool-card">
        <div>
          <div class="tool-card__topline">
            ...
            <span :class="getStatusBadgeClass('foundation')">Local MVP</span>
          </div>

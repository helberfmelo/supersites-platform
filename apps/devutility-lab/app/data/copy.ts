...
export const homeCopy: Record<LocaleCode, HomeCopy> = {
  en: {
    ...
    principles: [
      { title: 'Local by default', body: 'The tools run transformations in the browser and use a Web Worker when the browser supports it.' },
  ...
  'pt-br': {
    ...
    principles: [
      { title: 'Local por padrao', body: 'As ferramentas rodam transformacoes no navegador e usam Web Worker quando o browser suporta.' },
  ...
  es: {
    ...
    principles: [
      { title: 'Local por defecto', body: 'Las herramientas ejecutan transformaciones en el navegador y usan Web Worker cuando existe soporte.' },
  ...
  fr: {
    ...
    principles: [
      { title: 'Local par defaut', body: 'Les outils executent les transformations dans le navigateur et utilisent un Web Worker si disponible.' },
  ...
  de: {
    ...
    principles: [
      { title: 'Lokal zuerst', body: 'Die Tools fuehren Transformationen im Browser aus und nutzen Web Worker, wenn der Browser es unterstuetzt.' },

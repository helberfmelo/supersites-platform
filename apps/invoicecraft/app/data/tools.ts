...
const localizedBasics: Record<LocaleCode, {
  ...
  'pt-br': {
    ...
    gateBody: 'Linhas manuais de imposto sao apenas formatacao. Numeracao fiscal oficial, cobranca, recorrencia, clientes salvos e equipe precisam de controles separados de conta.',

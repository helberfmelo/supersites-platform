...
export const homeCopy: Record<LocaleCode, HomeCopy> = {
  en: {
    ...
    principles: [
      ...
      { title: 'Account options', body: 'Saved clients, recurrence, branding, teams, payments and history are separate from the free document builder.' },
    ],
    statusRows: [
  ...
  'pt-br': {
    eyebrow: 'InvoiceCraft',
    title: 'Faturas, orçamentos e recibos sem cadastro obrigatório.',
    ...
    searchPlaceholder: 'Tente fatura, orçamento ou recibo',
    ...
    principles: [
      { title: 'Necessidade básica', body: 'O fluxo gratuito cria um documento útil e PDF sem exigir conta.' },
      { title: 'Dados locais', body: 'Emissor, cliente, itens e valores ficam nesta sessão do navegador e não são enviados a analytics.' },
      { title: 'Fluxo avançado', body: 'Clientes salvos, recorrência, branding, equipe, pagamentos e histórico ficam separados do gerador gratuito.' },
    ],
    statusRows: [
      { title: '3 estúdios de documento', body: 'Fatura, orçamento e recibo abrem com editor, preview e PDF.', tone: 'green' },
      { title: '5 conjuntos de idioma', body: 'Páginas em inglês, português, espanhol, francês e alemão são prerenderizadas.', tone: 'green' },
      { title: 'PDF no navegador', body: 'O documento gratuito é gerado localmente sem cadastro obrigatório.', tone: 'green' },
    ],
  },
  es: {
    eyebrow: 'InvoiceCraft',
    ...
    principles: [
      ...
      { title: 'Opciones de cuenta', body: 'Clientes guardados, recurrencia, marca, equipos, pagos e historial quedan para funciones futuras de cuenta.' },
    ],
    statusRows: [
  ...
  fr: {
    ...
    principles: [
      ...
      { title: 'Options de compte', body: 'Clients sauvegardes, recurrence, marque, equipes, paiements et historique restent pour des fonctions futures de compte.' },
    ],
    statusRows: [
  ...
  de: {
    ...
    principles: [
      ...
      { title: 'Kontofunktionen', body: 'Kunden, Wiederholung, Branding, Teams, Zahlungen und Verlauf bleiben fuer kuenftige Kontofunktionen.' },
    ],
    statusRows: [
...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    resultTitle: 'Preview',
    guideTitle: 'How to use this document tool',
    faqTitle: 'FAQ',
    methodologyLabel: 'Methodology',
    editorialLabel: 'Editorial policy',
    freeCheckLabel: 'Free document',
    upgradePathLabel: 'Upgrade path',
    contentQualityBody: 'Fill the document, review totals and download the PDF when the preview looks right.',
    ...
    futureTitle: 'Advanced account options',
    futureBody: 'Saved data, recurrence, branding, team access, payments and fiscal templates belong to future account features.',
    ...
    futureListTitle: 'Future account options',
  ...
  'pt-br': {
    ...
    resultTitle: 'Preview',
    guideTitle: 'Como usar esta ferramenta de documento',
    faqTitle: 'Perguntas frequentes',
    methodologyLabel: 'Metodologia',
    editorialLabel: 'Politica editorial',
    freeCheckLabel: 'Documento gratuito',
    upgradePathLabel: 'Caminho de upgrade',
    contentQualityBody: 'Preencha o documento, revise os totais e baixe o PDF quando o preview estiver correto.',
    ...
    futureTitle: 'Recursos avancados de conta',
    ...
    futureListTitle: 'Opcoes futuras de conta',
  ...
  es: {
    ...
    guideTitle: 'Como usar esta herramienta de documento',
    faqTitle: 'Preguntas frecuentes',
    methodologyLabel: 'Metodologia',
    editorialLabel: 'Politica editorial',
    freeCheckLabel: 'Documento gratis',
    upgradePathLabel: 'Ruta de upgrade',
    contentQualityBody: 'Completa el documento, revisa los totales y descarga el PDF cuando la vista esté correcta.',
    ...
    futureTitle: 'Funciones avanzadas de cuenta',
    ...
    futureListTitle: 'Opciones futuras de cuenta',
  ...
  fr: {
    ...
    resultTitle: 'Apercu',
    guideTitle: 'Comment utiliser cet outil de document',
    faqTitle: 'FAQ',
    ...
    contentQualityBody: 'Remplissez le document, vérifiez les totaux et téléchargez le PDF quand l aperçu est correct.',
    ...
    futureTitle: 'Fonctions avancees de compte',
    ...
    futureListTitle: 'Options futures de compte',
  ...
  de: {
    ...
    guideTitle: 'So nutzen Sie dieses Dokument-Tool',
    faqTitle: 'FAQ',
    ...
    contentQualityBody: 'Füllen Sie das Dokument aus, prüfen Sie Summen und laden Sie das PDF nach der Vorschau herunter.',
    ...
    futureTitle: 'Erweiterte Kontofunktionen',
    futureBody: 'Gespeicherte Daten, Wiederholung, Branding, Teams, Zahlungen und Steuervorlagen gehoeren zu kuenftigen Kontofunktionen.',
    ...
    futureListTitle: 'Kuenftige Kontooptionen',

...
import { invoiceCraftToolCatalog } from './tools'
import {
...
export const siteBaseUrl = 'https://opentshost.com/supersites/invoicecraft'

export const contentPrerenderRoutes = [
  '/',
  ...publicLocaleCodes.flatMap((locale) => [
    localizedHomePath(locale),
    ...invoiceCraftToolCatalog.map((tool) => localizedToolPath(locale, tool.slug)),

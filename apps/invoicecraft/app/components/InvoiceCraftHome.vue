...
useHead(() => ({
  ...
  title: props.xDefault ? 'InvoiceCraft' : `${copy.value.title} | InvoiceCraft`,
  meta: [
    {
      name: 'description',
...
<template>
  <main class="page-shell">
    ...
    <section class="hero" aria-labelledby="invoicecraft-title">
      ...
      <aside class="status-panel" aria-label="Sprint 4.2 status">
      ...
      <article v-for="tool in filteredTools" :key="tool.slug" class="tool-card">
        <div>
          <div class="tool-card__topline">
            ...
            <span :class="getStatusBadgeClass('foundation')">Sprint 4.2</span>
          </div>

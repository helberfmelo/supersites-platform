...
export const homeCopy: Record<LocaleCode, HomeCopy> = {
  en: {
    ...
    lead: 'Search practical tools for IP, DNS, PDFs, QR codes, JSON, images, invoices, time zones and website checks. Open the free tool directly, no account required.',
    launchDeskTitle: 'Tool finder',
    launchDeskBody: 'Browse each focused site when you want a fuller tool set around one task family.',
    ...
    clustersTitle: 'Choose by task',
    clusterCtaLabel: 'Open cluster',
    liveEvidenceTitle: 'No account required',
    liveEvidenceBody: 'Open useful public tools before any account step.',
    featuredTools: [
      ...
      { siteSlug: 'devutility-lab', label: 'Local code tools', body: 'Formatter, diff, JWT, regex and hash utilities that keep snippets local.' },
    ...
    popularTools: [
      ...
      { siteSlug: 'docshift', label: 'PDF Merge', body: 'Combine PDFs with a simple browser-first tool.', path: '/tools/pdf-merge' },
    ],
    intentClusters: [
      ...
      { title: 'Create client documents', body: 'Draft invoices, quotes, receipts and PDFs with browser-first tools.', siteSlugs: ['invoicecraft', 'docshift'] },
    ...
    noResultsBody: 'Try another keyword or category. The catalog groups tools by the task they help you complete.',
    freeLabel: 'Free value',
    upgradeLabel: 'Advanced options',
    statusLabel: 'Status',
    toolTracksLabel: 'tool tracks',
    localesLabel: 'locales',
    gatedLabel: 'Useful free tool',
    launchOrderLabel: 'Product family',
    networkRows: [
      { title: 'No account required', body: 'Open practical pages before any account step.', tone: 'green' },
    ...
    principles: [
      ...
      { title: 'Respectful growth', body: 'Advanced options stay separate from the free answer and never interrupt the core task.' },
    ],
    supportEyebrow: 'Community support',
    supportTitle: 'Support the free network',
    supportBody: 'The best support today is practical: share useful tools, report corrections and bookmark the pages you use most.',
    supportActions: ['Share a tool', 'Send a correction', 'Use the free tools'],
  },
  'pt-br': {
    ...
    featuredTools: [
      ...
      { siteSlug: 'devutility-lab', label: 'Ferramentas locais de codigo', body: 'Formatter, diff, JWT, regex e hash mantendo trechos locais.' },
  ...
  es: {
    ...
    featuredTools: [
      ...
      { siteSlug: 'devutility-lab', label: 'Herramientas locales de codigo', body: 'Formatter, diff, JWT, regex y hash manteniendo fragmentos locales.' },
  ...
  fr: {
    ...
    featuredTools: [
      ...
      { siteSlug: 'devutility-lab', label: 'Outils de code locaux', body: 'Formatter, diff, JWT, regex et hash gardant les extraits locaux.' },
  ...
  de: {
    ...
    featuredTools: [
      ...
      { siteSlug: 'devutility-lab', label: 'Lokale Code-Tools', body: 'Formatter, Diff, JWT, Regex und Hash mit lokalen Snippets.' },
...
export const netProbeCatalogCopy: Record<LocaleCode, NetProbeCatalogCopy> = {
  en: {
    ...
    levels: [
      ...
      { title: 'For ongoing monitoring', body: 'Use the same checks as the basis for alert rules, history and API access when repeated evidence matters.' },
    ],
...
export const calcHarborCatalogCopy: Record<LocaleCode, CalcHarborCatalogCopy> = {
  en: {
    ...
    futureTopics: [
      ...
      { title: 'Team features', body: 'Saved comparisons and exports remain separate from the free one-off answer.' },
    ],
    footerGroups: [
      {
...
export const detailCopy: Record<LocaleCode, DetailCopy> = {
  en: {
    ...
    paidBenefitsTitle: 'Advanced account features',
    ...
    methodologyBody: 'This page summarizes the free task, the result a visitor receives first and the practical next step after the tool finishes.',
  ...
  de: {
    ...
    paidBenefitsTitle: 'Erweiterte Kontofunktionen',
...
export const devUtilityCatalogCopy: Record<LocaleCode, DevUtilityCatalogCopy> = {
  en: {
    ...
    finderTitle: 'Developer tool finder',
  ...
  'pt-br': {
    ...
    finderTitle: 'Buscador de ferramentas dev',
  ...
  fr: {
    ...
    finderTitle: 'Recherche d outils dev',
...
export const qrRouteCatalogCopy: Record<LocaleCode, QrRouteCatalogCopy> = {
  en: {
    ...
    lead: 'Start with static QR, Wi-Fi, vCard, UTM, barcode and payload preview tools. The free tool runs in the browser before any account path.',
...
export const invoiceCraftCatalogCopy: Record<LocaleCode, InvoiceCraftCatalogCopy> = {
  en: {
    ...
    lead: 'Start with an invoice, quote or receipt builder that keeps names, items and amounts in the browser. The free builder creates one polished PDF without an account.',
...
export const mailHealthCatalogCopy: Record<LocaleCode, MailHealthCatalogCopy> = {
  en: {
    ...
    limitsBody: 'Public tools inspect current records, selected public hosts or pasted headers. Recurring alerts, history, report ingestion, exports and team tools are separate account features.',
  ...
  'pt-br': {
    ...
    secondaryCta: 'Ver verificacoes de e-mail',
    ...
    reportScoreValue: '82',
    reportGrade: 'Revisar',
    reportBody: 'Um relatório útil começa por autenticação, rota de recebimento, reputação e evidências da mensagem. Abra cada verificação para resultado real no seu domínio.',
    reportSignals: [
    ...
    browseBody: 'O MailHealth segue o modelo de caixa de ferramentas: informe um domínio, escolha a verificacao exata, leia o sinal e corrija o DNS ou ajuste de e-mail responsável.',
    featuredTitle: 'Comece pelas verificacoes esperadas',
    featuredBody: 'Abra SPF, DKIM, DMARC, MX, blacklist, SMTP ou analise de cabecalhos diretamente. Cada pagina deixa a resposta gratuita primeiro e os limites abaixo.',
    limitsTitle: 'Verificacoes pontuais',
    ...
    privacyBody: 'Domínios, selectors, hosts de e-mail, cabecalhos e resultados não entram em eventos de analytics. A analise de cabecalhos roda no navegador.',
    searchLabel: 'Buscar verificacoes MailHealth',
    searchPlaceholder: 'Tente SPF, DMARC, SMTP, blacklist...',
    allCategories: 'Todas as verificacoes de e-mail',
    ...
    tools: [
      ...
      { label: 'Analisador de cabecalhos', body: 'Analise cabecalhos brutos localmente em busca de SPF, DKIM, DMARC e alinhamento.', path: '/tools/header-analyzer', glyph: 'HDR', category: 'headers', featured: true },
    ],
    shortcutGroups: [
      ...
      { title: 'Investigar evidencias', body: 'Compare reputacao com cabecalhos colados quando uma mensagem real parecer suspeita.', paths: ['/tools/blacklist-check', '/tools/header-analyzer', '/tools/dmarc-checker'] },
    ],
    footerGroups: [
      ...
      { title: 'Mensagem', links: [{ label: 'Analisar cabecalhos', path: '/tools/header-analyzer' }, { label: 'SPF nos cabecalhos', path: '/tools/header-analyzer' }] },
...
export const sitePulseCatalogCopy: Record<LocaleCode, SitePulseCatalogCopy> = {
  ...
  'pt-br': {
    ...
    secondaryCta: 'Ver verificacoes de site',
    ...
    reportScoreValue: '92',
    reportGrade: 'Online',
    reportBody: 'Uma verificacao web util responde a primeira pergunta rapido e separa rota, cabecalhos, arquivos de rastreamento e tempo para deixar claro onde agir.',
    reportSignals: [
      { label: 'Status', status: 'Online', detail: 'A resposta final está acessível com uma classe saudável.' },
      { label: 'Redirecionamentos', status: 'Limpo', detail: 'A rota chega à URL final sem cadeia longa.' },
      { label: 'Cabecalhos', status: 'Revisar', detail: 'Cabecalhos de seguranca ficam visiveis para checagem de base.' },
      { label: 'Tempo', status: 'Rápido', detail: 'A amostra de TTFB fica na primeira faixa de triagem.' },
    ],
    browseTitle: 'Escolha uma verificacao de site',
    browseBody: 'Use o SitePulse como uma caixa operacional compacta: informe uma URL publica, escolha a verificacao exata, leia o status e va para a camada responsavel.',
    ...
    limitsBody: 'As verificacoes publicas inspecionam uma URL, cabecalhos selecionados e arquivos de rastreamento da mesma origem com requisicoes limitadas. Verificacoes recorrentes, historico, incidentes e relatorios ficam separados da resposta gratuita.',
    privacyTitle: 'Alvos fora do analytics',
    privacyBody: 'URLs enviadas, destinos de redirecionamento, cabecalhos, tempos e detalhes de resultado não entram em eventos de analytics do produto.',
    searchLabel: 'Buscar verificacoes SitePulse',
    searchPlaceholder: 'Tente status, redirecionamentos, cabecalhos, sitemap...',
    allCategories: 'Todas as verificacoes de site',
    noResultsTitle: 'Nenhuma verificacao encontrada',
    noResultsBody: 'Tente outra palavra ou categoria. Só entram links para páginas SitePulse públicas existentes.',
    allTitle: 'Todas as verificacoes SitePulse publicadas',
    allBody: 'Alterne entre disponibilidade, rota, cabecalhos de seguranca, rastreamento e resumo de desempenho sem sair da caixa publica.',
    toolCta: 'Abrir verificacao',
    categories: [
      { key: 'availability', label: 'Disponibilidade' },
      { key: 'routing', label: 'Redirecionamentos' },
      { key: 'security', label: 'Cabecalhos' },
    ...
    tools: [
      ...
      { label: 'Cadeia de redirecionamento', body: 'Siga redirecionamentos limitados e encontre loops, troca de host ou handoffs lentos antes de mexer em canonicals.', path: '/tools/redirect-chain', glyph: '301', category: 'routing', featured: true },
      { label: 'Cabecalhos de seguranca', body: 'Inspecione HSTS, CSP, frame, referrer e cabecalhos de conteudo na resposta publica.', path: '/tools/security-headers', glyph: 'HDR', category: 'security', featured: true },
    ...
    shortcutGroups: [
      ...
      { title: 'A rota mudou?', body: 'Trace redirecionamentos e status final quando dominio, CDN ou regra canonical mudar.', paths: ['/tools/redirect-chain', '/tools/status-checker', '/tools/performance-snapshot'] },
      { title: 'Crawlers conseguem ler?', body: 'Revise robots.txt, sitemap.xml e cabecalhos que afetam descoberta e renderizacao.', paths: ['/tools/robots-checker', '/tools/sitemap-validator', '/tools/security-headers'] },
      { title: 'A pagina esta lenta?', body: 'Use um resumo limitado para separar sintomas de redirecionamento, cabecalho, bytes e tempo.', paths: ['/tools/performance-snapshot', '/tools/ttfb-check'] },
    ],
    footerGroups: [
      { title: 'Disponibilidade', links: [{ label: 'Status de site', path: '/tools/status-checker' }, { label: 'TTFB', path: '/tools/ttfb-check' }, { label: 'Resumo de desempenho', path: '/tools/performance-snapshot' }] },
      { title: 'Redirecionamentos', links: [{ label: 'Cadeia de redirecionamento', path: '/tools/redirect-chain' }, { label: 'Status final', path: '/tools/status-checker' }] },
      { title: 'Cabecalhos', links: [{ label: 'Cabecalhos de seguranca', path: '/tools/security-headers' }, { label: 'Cabecalhos da resposta', path: '/tools/security-headers' }] },
...
export const pixelBatchCatalogCopy: Record<LocaleCode, PixelBatchCatalogCopy> = {
  en: {
    ...
    browseTitle: 'Choose an image task',
    ...
    featuredBody: 'Each published PixelBatch page starts with a browser-side file task, preview, privacy checklist and download path before deeper notes.',
  ...
  'pt-br': {
    ...
    browseTitle: 'Escolha uma tarefa de imagem',
  ...
  de: {
    ...
    browseTitle: 'Bildaufgabe wählen',
...
export const docShiftCatalogCopy: Record<LocaleCode, DocShiftCatalogCopy> = {
  en: {
    ...
    lead: 'Merge, split, rotate, compress, watermark, number pages, clean metadata or turn text into a PDF with a practical local tool and no account requirement.',
    primaryCta: 'Merge PDFs',
    secondaryCta: 'Browse PDF tools',
    dropTitle: 'Drop or choose PDF files',
    dropBody: 'Start with a small PDF task. The public tools open local controls before any account step.',
    ...
    featuredBody: 'Every published DocShift page opens with a practical file or text task, a result panel and privacy guidance before deeper notes.',
  ...
  'pt-br': {
    ...
    browseTitle: 'Escolha uma tarefa de PDF',
  ...
  de: {
    ...
    browseTitle: 'PDF-Aufgabe wählen',
...
export const footerCopy: Record<LocaleCode, FooterCopy> = {
  en: {
    brandBody: 'A portfolio of practical web tools with localized public pages, useful free tools and clearly separated account features.',

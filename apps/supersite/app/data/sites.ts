  ...
  },
  {
    ...
    localized: {
      en: {
        ...
        summary: 'CalcHarbor will prioritize transparent calculations, examples and interpretation so the free result is useful without hiding the answer behind signup.',
      ...
      'pt-br': {
        ...
        summary: 'CalcHarbor vai priorizar cálculo transparente, exemplos e interpretação para que o resultado gratuito seja útil sem esconder a resposta atrás de cadastro.',
      ...
      es: {
        ...
        summary: 'CalcHarbor priorizará cálculos transparentes, ejemplos e interpretación para que el resultado gratuito sea útil sin ocultar la respuesta detrás de un registro.',
      ...
      fr: {
        ...
        summary: 'CalcHarbor privilégiera les calculs transparents, les exemples et l’interprétation afin que le résultat gratuit reste utile sans compte obligatoire.',
      ...
      de: {
        ...
        summary: 'CalcHarbor priorisiert transparente Berechnungen, Beispiele und Interpretation, damit das kostenlose Ergebnis ohne Registrierung nutzbar bleibt.',

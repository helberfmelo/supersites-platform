...
const copyByLocale: Record<LocaleCode, DonationCopy> = {
  en: {
    ...
    note: 'Choose an amount before the secure payment page opens.',
    error: 'Could not open the payment page right now. Please try again shortly.',
    ...
    panelSubtitle: 'Choose the amount and currency. Next, you will go to a secure hosted payment page to enter the payment details. The free tools stay available without a donation.',
    amountLabel: 'Amount',
    currencyLabel: 'Currency',
    continueLabel: 'Continue to secure payment',
    closeLabel: 'Close donation window',
    cancelLabel: 'Back to page',
    securityTitle: 'Before you continue',
    policyTitle: 'Donation policy',
    footerPrefix: 'Open Tecnologia e Serviços Ltda.',
    poweredBy: 'Payment is handled in a secure external payment environment. SuperSites does not receive or store card data.',
    validation: 'Enter an amount within the allowed range for this currency.',
    trustItems: [
      'No SuperSites account is required.',
      'Card details are entered only on the secure payment page.',
    ...
    policyItems: [
      ...
      'If you sent the wrong amount or need help, contact us with the payment receipt id.',
    ],
    links: {
      terms: 'Terms',
      privacy: 'Privacy',
  ...
  'pt-br': {
    ...
    note: 'Escolha valor e moeda antes de abrir a página segura de pagamento.',
    error: 'Não foi possível abrir a página de pagamento agora. Tente novamente em instantes.',
    ...
    panelSubtitle: 'Escolha o valor e a moeda. Em seguida, você será encaminhado para uma página segura onde poderá informar os dados de pagamento. As ferramentas gratuitas continuam disponíveis sem doação.',
    amountLabel: 'Valor',
    currencyLabel: 'Moeda',
    continueLabel: 'Continuar para pagamento seguro',
    closeLabel: 'Fechar janela de doação',
    cancelLabel: 'Voltar para a página',
    securityTitle: 'Antes de continuar',
    policyTitle: 'Política de doação',
    footerPrefix: 'Open Tecnologia e Serviços Ltda.',
    poweredBy: 'O pagamento é processado em ambiente seguro externo. O SuperSites não recebe nem armazena dados do cartão.',
    validation: 'Informe um valor dentro do limite permitido para esta moeda.',
    trustItems: [
      'Nenhuma conta SuperSites é obrigatória.',
      'Os dados do cartão são informados somente na página segura de pagamento.',
      'A doação não compra prioridade, recursos, SLA ou consultoria jurídica.',
    ],
    policyItems: [
      'Doações são apoio voluntário para manter ferramentas públicas gratuitas.',
      'Elas não são dedutíveis de imposto salvo quando sua lei local e seus registros permitirem.',
      'Se enviou valor errado ou precisa de ajuda, fale conosco com o identificador do recibo de pagamento.',
    ],
    links: {
      terms: 'Termos',
      privacy: 'Privacidade',
  ...
  es: {
    ...
    note: 'Elige importe y moneda antes de abrir la página segura de pago.',
    error: 'No se pudo abrir la página de pago ahora. Inténtalo de nuevo en unos instantes.',
    ...
    panelSubtitle: 'Elige importe y moneda. Luego irás a una página segura donde podrás introducir los datos de pago. Las herramientas gratis siguen disponibles sin donar.',
    amountLabel: 'Importe',
    currencyLabel: 'Moneda',
    continueLabel: 'Continuar al pago seguro',
    closeLabel: 'Cerrar ventana de donación',
    cancelLabel: 'Volver a la página',
    securityTitle: 'Antes de continuar',
    policyTitle: 'Política de donación',
    footerPrefix: 'Open Tecnologia e Serviços Ltda.',
    poweredBy: 'El pago se procesa en un entorno externo seguro. SuperSites no recibe ni almacena datos de tarjeta.',
    validation: 'Introduce un importe dentro del rango permitido para esta moneda.',
    trustItems: [
      'No necesitas cuenta SuperSites.',
      'Los datos de tarjeta se introducen solo en la página segura de pago.',
      'La donación no compra prioridad, funciones, SLA ni asesoría legal.',
    ],
    policyItems: [
      'Las donaciones son apoyo voluntario para mantener herramientas públicas gratis.',
      'No son deducibles de impuestos salvo que tu ley local y tus registros lo permitan.',
      'Si enviaste un importe incorrecto o necesitas ayuda, contáctanos con el identificador del recibo de pago.',
    ],
    links: {
      terms: 'Términos',
      privacy: 'Privacidad',
  ...
  fr: {
    ...
    note: 'Choisissez le montant et la devise avant d’ouvrir la page de paiement sécurisée.',
    error: 'Impossible d’ouvrir la page de paiement maintenant. Réessayez dans un instant.',
    title: 'Soutien optionnel pour les outils gratuits SuperSites',
    panelEyebrow: 'Soutien optionnel sécurisé',
    panelTitle: 'Soutenir les outils gratuits SuperSites',
    panelSubtitle: 'Choisissez le montant et la devise. Vous serez ensuite redirigé vers une page sécurisée pour saisir les informations de paiement. Les outils gratuits restent disponibles sans don.',
    amountLabel: 'Montant',
    currencyLabel: 'Devise',
    continueLabel: 'Continuer vers le paiement sécurisé',
    closeLabel: 'Fermer la fenêtre de don',
    cancelLabel: 'Retour à la page',
    securityTitle: 'Avant de continuer',
    policyTitle: 'Politique de don',
    footerPrefix: 'Open Tecnologia e Serviços Ltda.',
    poweredBy: 'Le paiement est traité dans un environnement externe sécurisé. SuperSites ne reçoit ni ne stocke les données de carte.',
    validation: 'Saisissez un montant dans la limite autorisée pour cette devise.',
    trustItems: [
      'Aucun compte SuperSites n’est requis.',
      'Les données de carte sont saisies uniquement sur la page de paiement sécurisée.',
      'Le don n’achète pas priorité, fonctions, SLA ou conseil juridique.',
    ],
    policyItems: [
      'Les dons soutiennent volontairement les outils publics gratuits.',
      'Ils ne sont pas déductibles fiscalement sauf si votre droit local et vos dossiers le permettent.',
      'Pour une erreur de montant ou une demande d’aide, contactez-nous avec l’identifiant du reçu de paiement.',
    ],
    links: {
      terms: 'Conditions',
  ...
  de: {
    label: 'Spenden',
    loadingLabel: 'Öffnet...',
    note: 'Betrag und Währung vor dem Öffnen der sicheren Zahlungsseite wählen.',
    error: 'Die Zahlungsseite konnte gerade nicht geöffnet werden. Bitte versuchen Sie es gleich erneut.',
    title: 'Optionale Unterstützung für die kostenlosen SuperSites-Tools',
    panelEyebrow: 'Sichere optionale Unterstützung',
    panelTitle: 'Kostenlose SuperSites-Tools unterstützen',
    panelSubtitle: 'Wählen Sie Betrag und Währung. Danach werden Sie auf eine sichere Zahlungsseite weitergeleitet, um die Zahlungsdaten einzugeben. Die kostenlosen Tools bleiben ohne Spende verfügbar.',
    amountLabel: 'Betrag',
    currencyLabel: 'Währung',
    continueLabel: 'Weiter zur sicheren Zahlung',
    closeLabel: 'Spendenfenster schließen',
    cancelLabel: 'Zurück zur Seite',
    securityTitle: 'Vor dem Fortfahren',
    policyTitle: 'Spendenrichtlinie',
    footerPrefix: 'Open Tecnologia e Serviços Ltda.',
    poweredBy: 'Die Zahlung wird in einer sicheren externen Zahlungsumgebung verarbeitet. SuperSites erhält oder speichert keine Kartendaten.',
    validation: 'Geben Sie einen Betrag innerhalb des erlaubten Bereichs ein.',
    trustItems: [
      'Kein SuperSites-Konto erforderlich.',
      'Kartendaten werden nur auf der sicheren Zahlungsseite eingegeben.',
      'Die Spende kauft keine Priorität, Funktionen, SLA oder Rechtsberatung.',
    ],
    policyItems: [
      'Spenden sind freiwillige Unterstützung für kostenlose öffentliche Tools.',
      'Sie sind nicht steuerlich absetzbar, außer lokales Recht und eigene Unterlagen erlauben es.',
      'Bei falschem Betrag oder Hilfebedarf kontaktieren Sie uns mit der Zahlungsbeleg-Kennung.',
    ],
    links: {
      terms: 'Bedingungen',
      privacy: 'Datenschutz',

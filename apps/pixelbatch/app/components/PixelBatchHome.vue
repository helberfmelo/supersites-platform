...
const advancedCopy = computed(() => getPixelBatchAdvancedWorkflowCopy(props.locale))
...
<template>
  <main class="page-shell">
    ...
    <section class="band advanced-workflow-band" aria-labelledby="pixelbatch-advanced-title">
      <h2 id="pixelbatch-advanced-title">{{ advancedCopy.title }}</h2>

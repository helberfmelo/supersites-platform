...
export const homeCopy: Record<LocaleCode, HomeCopy> = {
  en: {
    ...
    footerToolsBody: 'Compress first, resize or crop for the channel, convert the format, clean metadata and generate social dimensions from the same local tool set.',
    principles: [
      ...
      { title: 'Pixels stay local', body: 'Selected files are handled with object URLs, local planning and Canvas output in the browser session.' },
      { title: 'Account features stay separate', body: 'Batch, folders, larger files, API, integrations, saved presets, high-res queues and AI credits stay in account features.' },
    ],
    statusRows: [
      ...
      { title: 'Your image stays in this browser', body: 'One selected file is decoded and re-encoded locally; account features remain separate.', tone: 'amber' },
    ],
  },
  'pt-br': {
    eyebrow: 'PixelBatch',
    ...
    footerToolsBody: 'Comprima primeiro, redimensione ou corte para o canal, converta formato, limpe metadados e gere dimensoes sociais no mesmo conjunto local.',
    principles: [
      ...
      { title: 'Pixels locais', body: 'Arquivos selecionados usam object URLs, planejamento local e Canvas apenas na sessao do navegador.' },
      { title: 'Recursos de conta', body: 'Lotes, pastas, arquivos maiores, API, integracoes, presets salvos, alta resolucao e IA ficam nos recursos de conta.' },
    ],
    statusRows: [
      ...
      { title: 'Sua imagem fica neste navegador', body: 'Um arquivo selecionado e decodificado e reencodeado localmente; recursos de conta ficam separados.', tone: 'amber' },
    ],
  },
  es: {
    eyebrow: 'PixelBatch',
    ...
    footerToolsBody: 'Comprime primero, redimensiona o recorta para el canal, convierte formato, limpia metadatos y crea dimensiones sociales en el mismo conjunto local.',
    principles: [
      { title: 'Necesidad basica', body: 'La herramienta gratis del navegador produce una imagen util sin cuenta ni endpoint de subida.' },
      { title: 'Pixeles locales', body: 'Los archivos usan object URLs, plan local y Canvas en la sesion del navegador.' },
      { title: 'Funciones de cuenta', body: 'Lotes, carpetas, archivos grandes, API, integraciones, presets, alta resolucion e IA quedan en funciones de cuenta.' },
    ],
    statusRows: [
      ...
      { title: 'Tu imagen queda en este navegador', body: 'Un archivo seleccionado se decodifica y re-codifica localmente; las funciones de cuenta quedan separadas.', tone: 'amber' },
    ],
  },
  fr: {
    eyebrow: 'PixelBatch',
    ...
    footerToolsBody: 'Compressez, redimensionnez ou rognez pour le canal, convertissez le format, nettoyez les metadonnees et creez des dimensions sociales dans le meme ensemble local.',
    principles: [
      { title: 'Besoin de base', body: 'L outil gratuit du navigateur produit une image utile sans compte ni upload.' },
      { title: 'Pixels locaux', body: 'Les fichiers utilisent des object URLs, un plan local et Canvas dans la session navigateur.' },
      { title: 'Fonctions de compte', body: 'Lots, dossiers, gros fichiers, API, integrations, presets, haute resolution et IA restent dans les fonctions de compte.' },
    ],
    statusRows: [
      ...
      { title: 'Votre image reste dans ce navigateur', body: 'Un fichier choisi est decode et reencode localement; les fonctions de compte restent separees.', tone: 'amber' },
    ],
  },
  de: {
    eyebrow: 'PixelBatch',
    ...
    principles: [
      ...
      { title: 'Pixel bleiben lokal', body: 'Dateien werden mit Object URLs, lokaler Planung und Canvas nur in der Browser-Sitzung verarbeitet.' },
      { title: 'Kontofunktionen bleiben getrennt', body: 'Batch, Ordner, grosse Dateien, API, Integrationen, Presets, High-Res und KI bleiben Kontofunktionen.' },
    ],
    statusRows: [
      ...
      { title: 'Ihr Bild bleibt in diesem Browser', body: 'Eine ausgewaehlte Datei wird lokal decodiert und neu encodiert; Kontofunktionen bleiben getrennt.', tone: 'amber' },
    ],
  },
}
...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    freeCheckLabel: 'Free image tool',
    ...
    liveBody: 'Local planning and Canvas rendering run in the browser without mandatory signup.',
    accountTitle: 'Account features',
    ...
    upgradeGateBody: 'Use the single-image browser tool now; batch, API, high-resolution queues and AI features are separate from the free result.',
  ...
  'pt-br': {
    ...
    liveBody: 'Processamento local e Canvas rodam no navegador sem cadastro obrigatorio.',
    accountTitle: 'Recursos de conta',
    accountBody: 'Pastas, arquivos maiores, API, presets salvos, integracoes, alta resolucao e IA ficam fora do resultado local gratuito.',
    ...
    batchQueueTitle: 'Opcoes em lote',
    ...
    workbenchEyebrow: 'Ferramentas de imagem',
    ...
    toolTabsLabel: 'Abas de tarefa de imagem',
    ...
    centeredCropNotice: 'Este corte e centralizado. Corte manual por sujeito nao esta ativo na ferramenta gratuita do navegador.',
    ...
    upgradeGateBody: 'Use uma imagem no navegador agora; lotes, API, filas de alta resolução e IA ficam separados do resultado gratuito.',
  ...
  es: {
    ...
    liveBody: 'Procesamiento local y Canvas corren en el navegador sin registro obligatorio.',
    accountTitle: 'Funciones de cuenta',
    accountBody: 'Carpetas, archivos grandes, API, presets, integraciones, alta resolucion e IA quedan fuera del resultado local gratis.',
    ...
    batchQueueTitle: 'Opciones batch',
    ...
    toolTabsLabel: 'Pestanas de tarea de imagen',
    openGuideLabel: 'Abrir guia',
    useCaseTitle: 'Presets de uso',
    ...
    centeredCropNotice: 'Este recorte es centrado. El recorte manual por sujeto no esta activo en la herramienta gratis del navegador.',
    ...
    upgradeGateBody: 'Usa una imagen en el navegador; lotes, API, colas de alta resolución e IA quedan separados del resultado gratuito.',
  ...
  fr: {
    ...
    liveBody: 'Traitement local et Canvas fonctionnent dans le navigateur sans compte obligatoire.',
    accountTitle: 'Fonctions de compte',
    accountBody: 'Dossiers, gros fichiers, API, presets, integrations, haute resolution et IA restent hors du resultat local gratuit.',
    ...
    batchQueueTitle: 'Options de lots',
    ...
    toolTabsLabel: 'Onglets de tache image',
    ...
    centeredCropNotice: 'Ce crop est centre. Le recadrage manuel par sujet n est pas actif dans l outil navigateur gratuit.',
    ...
    upgradeGateBody: 'Utilisez une image dans le navigateur; lots, API, files haute résolution et IA restent séparés du résultat gratuit.',
  ...
  de: {
    ...
    freeCheckLabel: 'Kostenloses Bildtool',
    ...
    liveBody: 'Lokale Verarbeitung und Canvas laufen im Browser ohne Pflichtkonto.',
    accountTitle: 'Kontofunktionen',
    ...
    batchQueueTitle: 'Batch-Optionen',
    ...
    toolTabsLabel: 'Bildaufgabe-Tabs',
    ...
    centeredCropNotice: 'Dieser Zuschnitt ist zentriert. Manueller subject-aware Zuschnitt ist im freien Browsertool nicht aktiv.',
    ...
    upgradeGateBody: 'Nutzen Sie jetzt ein Bild im Browser; Batch, API, High-Resolution-Queues und KI sind vom kostenlosen Ergebnis getrennt.',

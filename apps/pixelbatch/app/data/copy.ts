...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    batchQueueBody: 'Folders, queues, saved presets and automation need account controls, upload validation and retention rules before activation.',
  ...
  'pt-br': {
    ...
    batchQueueBody: 'Pastas, filas, presets salvos e automacao precisam de controles de conta, validacao de upload e regras de retencao antes da ativacao.',

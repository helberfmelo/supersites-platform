...
import { pixelBatchToolCatalog } from './tools'
import {
...
export const siteBaseUrl = 'https://opentshost.com/supersites/pixelbatch'

export const contentPrerenderRoutes = [
  '/',
  ...publicLocaleCodes.flatMap((locale) => [
    localizedHomePath(locale),
    ...pixelBatchToolCatalog.map((tool) => localizedToolPath(locale, tool.slug)),

...
const reportCopy: Record<LocaleCode, ReportCopy> = {
  ...
  'pt-br': {
    ...
    stateDescriptions: {
      ...
      redirecting: 'A pagina respondeu, com redirects que devem ser intencionais.',
      slow: 'A pagina respondeu, mas o tempo deve ser revisado antes de confiar no resultado.',
      down: 'A URL falhou, expirou ou retornou status nao saudavel nesta probe.',
    ...
    groupLabels: {
      ...
      redirects: 'Redirects',
      security: 'Headers de seguranca',
      crawlability: 'Rastreamento',
      performance: 'Performance',
    },
    groupDescriptions: {
      availability: 'Status HTTP final, timeout e alcance da resposta.',
      redirects: 'Quantidade de hops, loops e trocas inesperadas.',
      security: 'Headers basicos de seguranca no navegador na resposta final.',
    ...
    safeguards: [
      ...
      'Destinos privados, locais, reservados e de metadata sao recusados antes das requisicoes.',
      'Analytics recebe apenas rota e ferramenta, nunca URL testada ou valores do resultado.',
    ],
    upgradeTitle: 'Caminho de upgrade workflow',
    upgradeBody: 'Uptime recorrente, incidentes, status page, alertas, historico, relatorios e probes multi-regiao continuam como valor futuro.',
  },
  es: {

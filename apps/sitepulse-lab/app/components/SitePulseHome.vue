...
useHead(() => ({
  ...
  title: props.xDefault ? 'SitePulse Lab' : `${copy.value.title} | SitePulse Lab`,
  meta: [
    {
      name: 'description',
...
<template>
  <main class="page-shell">
    ...
    <section class="hero" aria-labelledby="sitepulse-title">
      <div>
        <p class="eyebrow">{{ copy.eyebrow }}</p>
        <h1 id="sitepulse-title">{{ copy.title }}</h1>
    ...
    <SitePulseReportWorkbench :locale="locale" />
    ...
    <section class="tool-grid" aria-label="SitePulse Lab tools">

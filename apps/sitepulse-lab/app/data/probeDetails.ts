...
const detailCopy: Record<LocaleCode, SitePulseDetailCopy> = {
  en: {
    ...
    reviewDetail: 'Detected, but confirm the setting against this site context.',
  ...
  'pt-br': {
    redirectPathTitle: 'Caminho de redirecionamentos',
    headerMatrixTitle: 'Matriz de cabecalhos',
    technologyTitle: 'Pistas de tecnologia',
    crawlabilityTitle: 'Arquivos de crawl',
    performanceTitle: 'Amostra de performance',
    warningsTitle: 'Notas da verificacao limitada',
    emptyRedirects: 'Nenhum salto de redirecionamento foi retornado nesta verificacao pontual.',
    presentDetail: 'Presente na resposta final.',
    missingDetail: 'Ausente na resposta final ou nao amostrado pela verificacao limitada.',
    reviewDetail: 'Detectado, mas confirme a configuracao no contexto deste site.',
    noHeaderSignals: 'Nenhuma matriz de cabecalhos foi retornada para esta verificacao.',
    noTechnologySignals: 'Nenhuma pista de tecnologia foi retornada pela verificacao limitada.',
    contentTypeDetail: 'Tipo de conteudo visto na resposta final.',
    serverHintDetail: 'Pista de servidor ou plataforma exposta pelos metadados da resposta.',
    cacheHintDetail: 'Pista de cache ou CDN exposta por cabecalhos publicos.',
    securityPolicyDetail: 'Sinal de seguranca do navegador exposto por cabecalhos publicos.',
    ttfbDetail: 'Amostra aproximada de primeiro byte em uma execucao da verificacao.',
    ...
    finalStatusDetail: 'Status HTTP final depois dos redirecionamentos limitados.',
    ...
    redirectCountLabel: 'Contagem de redirecionamentos',
  ...
  es: {
    ...
    reviewDetail: 'Detectado, pero confirma la configuracion en el contexto de este sitio.',
  ...
  fr: {
    ...
    reviewDetail: 'Detecte, mais confirmez le reglage dans le contexte de ce site.',

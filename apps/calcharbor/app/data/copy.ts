...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    contentQualityBody: 'This page combines the working calculator, formula, interpretation, example, limits and FAQ so the answer can be audited.',
  ...
  'pt-br': {
    ...
    contentQualityBody: 'Esta pagina combina calculadora funcional, formula, interpretacao, exemplo, limites e FAQ para que a resposta possa ser auditada.',
  ...
  es: {
    ...
    contentQualityBody: 'Esta pagina combina calculadora, formula, interpretacion, ejemplo, limites y FAQ para que la respuesta se pueda auditar.',
  ...
  fr: {
    ...
    contentQualityBody: 'Cette page combine calculatrice, formule, interpretation, exemple, limites et FAQ pour verifier la reponse.',
  ...
  de: {
    ...
    contentQualityBody: 'Diese Seite kombiniert Rechner, Formel, Interpretation, Beispiel, Grenzen und FAQ, damit die Antwort pruefbar ist.',

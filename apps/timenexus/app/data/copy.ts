...
export const homeCopy: Record<LocaleCode, HomeCopy> = {
  en: {
    ...
    principles: [
      ...
      { title: 'Account options', body: 'Advanced features belong in widgets, API automation, presets and collaboration.' },
    ],
    statusRows: [
  ...
  'pt-br': {
    ...
    principles: [
      ...
      { title: 'Opcoes de conta', body: 'Valor de upgrade fica em widgets, automacao por API, presets e colaboracao.' },
    ],
    statusRows: [
  ...
  es: {
    ...
    principles: [
      ...
      { title: 'Opciones de cuenta', body: 'El valor de upgrade esta en widgets, automatizacion por API, presets y colaboracion.' },
    ],
    statusRows: [
  ...
  fr: {
    ...
    principles: [
      ...
      { title: 'Options de compte', body: 'La valeur upgrade se trouve dans widgets, automatisation API, presets et collaboration.' },
    ],
    statusRows: [
  ...
  de: {
    ...
    principles: [
      ...
      { title: 'Kontooptionen', body: 'Upgrade-Wert liegt in Widgets, API-Automation, Presets und Zusammenarbeit.' },
    ],
    statusRows: [
...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    exampleBody: 'The form starts with a safe sample so the free result can be checked before entering private values.',
    relatedTitle: 'Related tools',
    relatedBody: 'Move to nearby time, date and conversion helpers without leaving the local tool set.',
    openRelatedLabel: 'Open',
    guideTitle: 'How to use this time tool',
    faqTitle: 'FAQ',
    ...
    liveBody: 'The free utility works without signup and runs with browser-side processing when supported.',
    gatedTitle: 'Account options',
    ...
    gatedItems: ['Embeddable widgets', 'Saved presets', 'Team sharing', 'API access', 'Calendar tools'],
  ...
  'pt-br': {
    ...
    guideTitle: 'Como usar esta ferramenta de tempo',
    ...
    liveTitle: 'Utilitario no navegador',
    liveBody: 'A ferramenta gratuita funciona sem cadastro e roda com processamento local quando suportado.',
  ...
  es: {
    ...
    openRelatedLabel: 'Abrir',
    guideTitle: 'Como usar esta herramienta de tiempo',
    ...
    liveTitle: 'Utilidad en navegador',
  ...
  fr: {
    ...
    guideTitle: 'Comment utiliser cet outil de temps',
    faqTitle: 'FAQ',
    ...
    liveTitle: 'Utilitaire navigateur',
  ...
  de: {
    ...
    guideTitle: 'So nutzen Sie dieses Zeit-Tool',
    faqTitle: 'FAQ',
    ...
    gatedItems: ['Einbettbare Widgets', 'Gespeicherte Presets', 'Teamfreigabe', 'API-Zugriff', 'Kalender-Tools'],

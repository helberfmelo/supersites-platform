...
const directoryText: Record<LocaleCode, {
  ...
  en: {
    ...
    sections: {
      ...
      timers: { title: 'Timers', body: 'Use the current time panel and meeting planner when you need a quick live reference.', currentTime: 'Current time panel', meetingPlanner: 'Meeting planner' },
    },
    footer: { cities: 'Cities', timeZones: 'Time zones', dates: 'Dates', calendars: 'Calendars', converters: 'Converters', businessFit: 'Business-hour fit', holidayCalendars: 'Holiday calendars' },
  },
  'pt-br': {
    ...
    sections: {
      ...
      timers: { title: 'Temporizadores', body: 'Use o painel de hora atual e o planejador quando precisar de uma referência rápida ao vivo.', currentTime: 'Painel de hora atual', meetingPlanner: 'Planejador de reuniao' },
    },
    footer: { cities: 'Cidades', timeZones: 'Fusos horarios', dates: 'Datas', calendars: 'Calendarios', converters: 'Conversores', businessFit: 'Ajuste de expediente', holidayCalendars: 'Calendarios de feriados' },
  },
  es: {
    ...
    sections: {
      ...
      timers: { title: 'Temporizadores', body: 'Usa el panel de hora actual y el planificador cuando necesites una referencia rápida en vivo.', currentTime: 'Panel de hora actual', meetingPlanner: 'Planificador de reunion' },
    },
    footer: { cities: 'Ciudades', timeZones: 'Zonas horarias', dates: 'Fechas', calendars: 'Calendarios', converters: 'Conversores', businessFit: 'Ajuste de horario laboral', holidayCalendars: 'Calendarios de festivos' },
  },
  fr: {
    ...
    sections: {
      ...
      timers: { title: 'Minuteurs', body: 'Utilisez le panneau d heure actuelle et le planificateur pour une reference rapide en direct.', currentTime: 'Panneau heure actuelle', meetingPlanner: 'Planificateur de reunion' },
    },
    footer: { cities: 'Villes', timeZones: 'Fuseaux horaires', dates: 'Dates', calendars: 'Calendriers', converters: 'Convertisseurs', businessFit: 'Ajustement heures ouvrables', holidayCalendars: 'Calendriers feries' },
  },
  de: {
    ...
    sections: {
      ...
      timers: { title: 'Timer', body: 'Nutzen Sie das aktuelle Zeitpanel und den Meeting-Planer fuer eine schnelle Live-Referenz.', currentTime: 'Aktuelle-Zeit-Panel', meetingPlanner: 'Meeting-Planer' },
    },
    footer: { cities: 'Staedte', timeZones: 'Zeitzonen', dates: 'Daten', calendars: 'Kalender', converters: 'Konverter', businessFit: 'Arbeitszeit-Passung', holidayCalendars: 'Feiertagskalender' },
  },
}

...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    gatedTitle: 'Advanced links planned',
    gatedBody: 'Dynamic QR, short links, analytics, custom domains, billing and ads stay disabled until the quality and abuse controls are ready.',
  ...
  'pt-br': {
    ...
    gatedTitle: 'Links avancados planejados',
    gatedBody: 'QR dinamico, short links, analytics, dominio proprio, billing e ads seguem desativados ate os controles de qualidade e abuso.',
  ...
  es: {
    ...
    gatedTitle: 'Enlaces avanzados planificados',
    gatedBody: 'QR dinamico, short links, analytics, dominio propio, billing y ads siguen desactivados hasta tener controles de calidad y abuso.',
  ...
  fr: {
    ...
    gatedTitle: 'Liens avances prevus',
    gatedBody: 'QR dynamique, short links, analytics, domaine propre, billing et ads restent desactives jusqu aux controles qualite et anti-abus.',
  ...
  de: {
    ...
    gatedTitle: 'Erweiterte Links geplant',
    gatedBody: 'Dynamische QR, Short Links, Analytics, eigene Domains, Billing und Ads bleiben aus, bis Qualitaets- und Abuse-Kontrollen bereit sind.',

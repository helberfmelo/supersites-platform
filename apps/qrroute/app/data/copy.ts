...
export const homeCopy: Record<LocaleCode, HomeCopy> = {
  en: {
    ...
    principles: [
      ...
      { title: 'No hidden redirect', body: 'Static previews encode the visible payload directly; editable QR and short links are optional account features.' },
      { title: 'Analytics without PII', body: 'Only tool slugs and safe route paths enter local events for this browser builder.' },
    ],
    statusRows: [
      { title: '6 local tools', body: 'Static QR, barcode, UTM, vCard, Wi-Fi and preview inspection.', tone: 'green' },
      { title: '5 language route sets', body: 'English, Portuguese, Spanish, French and German pages are prerendered.', tone: 'green' },
      { title: 'Account link options', body: 'Editable destinations, scan insights, custom domains, batch and API belong to optional account features.', tone: 'amber' },
    ],
...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    resultTitle: 'Payload',
    modeTabsTitle: 'Type',
    toolTabsTitle: 'QRRoute task tabs',
    workbenchEyebrow: 'Create now',
    workbenchTitle: 'Build a QR, barcode, UTM, vCard or Wi-Fi code with a local preview.',
    ...
    guideTitle: 'How to use this QR tool',
    faqTitle: 'FAQ',
  ...
  'pt-br': {
    ...
    guideTitle: 'Como usar esta ferramenta de QR',
  ...
  es: {
    ...
    guideTitle: 'Como usar esta herramienta de QR',
    ...
    liveTitle: 'Builder en navegador',
  ...
  fr: {
    ...
    guideTitle: 'Comment utiliser cet outil QR',
    faqTitle: 'FAQ',
  ...
  de: {
    ...
    guideTitle: 'So nutzen Sie dieses QR-Tool',
    faqTitle: 'FAQ',

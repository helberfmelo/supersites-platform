...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    contentQualityBody: 'This page combines a working local tool, safety limits, FAQ and review date before advanced commercial workflows.',
  ...
  'pt-br': {
    ...
    contentQualityBody: 'Esta pagina combina ferramenta local, limites de seguranca, FAQ e revisao antes de workflows comerciais avancados.',
  ...
  es: {
    ...
    contentQualityBody: 'Esta pagina combina herramienta local, limites de seguridad, FAQ y revision antes de workflows comerciales avanzados.',
  ...
  fr: {
    ...
    contentQualityBody: 'Cette page combine outil local, limites securite, FAQ et date de revue avant les workflows commerciaux avances.',
  ...
  de: {
    ...
    contentQualityBody: 'Diese Seite kombiniert lokales Tool, Sicherheitsgrenzen, FAQ und Pruefdatum vor einer kommerziellen Version.',

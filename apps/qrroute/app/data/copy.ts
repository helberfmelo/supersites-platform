...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    contentQualityBody: 'This page combines a working local tool, safety limits, FAQ and review date before any commercial release.',
  ...
  'pt-br': {
    ...
    contentQualityBody: 'Esta pagina combina ferramenta local, limites de seguranca, FAQ e revisao antes de qualquer release comercial.',
  ...
  es: {
    ...
    contentQualityBody: 'Esta pagina combina herramienta local, limites de seguridad, FAQ y revision antes de cualquier release comercial.',
  ...
  fr: {
    ...
    contentQualityBody: 'Cette page combine outil local, limites securite, FAQ et date de revue avant toute release commerciale.',

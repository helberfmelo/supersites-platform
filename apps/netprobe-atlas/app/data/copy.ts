...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    plannedTitle: 'Launch gate',
    plannedBody: 'Live checks are available locally; production publication still waits for deploy, monitoring and rollback gates.',
  ...
  'pt-br': {
    ...
    plannedTitle: 'Launch gate',
    plannedBody: 'As consultas live funcionam localmente; produção ainda depende de deploy, monitoramento e rollback.',
  ...
  es: {
    ...
    relatedTitle: 'Páginas relacionadas',
    plannedTitle: 'Launch gate',
    plannedBody: 'Las consultas live funcionan localmente; producción espera deploy, monitoreo y rollback.',
  ...
  fr: {
    ...
    plannedTitle: 'Launch gate',
    plannedBody: 'Les contrôles live fonctionnent localement; la production attend déploiement, surveillance et rollback.',
  ...
  de: {
    ...
    plannedTitle: 'Launch-Gate',
    plannedBody: 'Live-Prüfungen funktionieren lokal; Produktion wartet noch auf Deploy, Monitoring und Rollback.',

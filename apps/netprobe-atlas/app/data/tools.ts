...
export const toolCatalog: ToolDefinition[] = [
  ...
  makeTool('rdap-domain-lookup', 'domain', 'RDAP lookup', {
    en: {
      ...
      fix: 'Use the registrar account for authoritative billing and renewal data, then use NetProbe for external visibility and reminders.',
  ...
  makeTool('dns-propagation', 'dns', 'Propagation', {
    en: {
      ...
      limitation: 'This version does not promise worldwide propagation until regional worker probes are deployed and documented.',
      faq: [
        {
          question: 'Is this a worldwide propagation checker?',
          answer: 'Not yet. It reports controlled snapshots and labels resolver scope until multi-region workers are available.',
        },
        {
      ...
      faq: [
        {
          ...
          answer: 'Ainda não. Ele mostra snapshots controlados e informa o escopo até existirem workers multirregião.',
        },
        {
      ...
      faq: [
        {
          ...
          answer: 'Todavía no. Informa snapshots controlados y alcance del resolver hasta tener workers multirregión.',
        },
        {
      ...
      faq: [
        {
          ...
          answer: 'Pas encore. Il rapporte des snapshots contrôlés et leur portée jusqu’à disponibilité des workers multirégion.',
        },
        {
    ...
    de: {
      ...
      limitation: 'Diese Version verspricht keine weltweite Propagation, bis regionale Worker-Probes bereitstehen und dokumentiert sind.',
      faq: [
        {
          question: 'Ist das ein weltweiter Propagation-Checker?',
          answer: 'Noch nicht. Er zeigt kontrollierte Snapshots und deren Scope, bis Multi-Region-Worker verfügbar sind.',
        },
        {
  ...
  makeTool('ping-traceroute', 'reachability', 'Ping and trace', {
    en: {
      ...
      previewResult: 'Latency and hop summaries are limited to safe probes until worker infrastructure is available.',
      statusLabel: 'Live API',
      ...
      exampleTarget: 'example.com',
      measure: 'The current request path checks TCP 443 with fixed timeout limits and reports ICMP/traceroute as unavailable until workers exist.',
      ...
      limitation: 'Traceroute requires controlled worker infrastructure; the browser-facing API does not run arbitrary packet path probes.',
      faq: [
        {
          question: 'Why is traceroute marked not supported?',
          answer: 'Traceroute needs controlled workers and stricter abuse controls. The initial web runtime reports bounded TCP reachability first.',
        },
        {
    ...
    'pt-br': {
      ...
      previewResult: 'Latência e caminho ficam limitados a probes seguros até existir infraestrutura de workers.',
      statusLabel: 'API ativa',
      ...
      exampleTarget: 'example.com',
      measure: 'O caminho atual testa TCP 443 com timeout fixo e informa ICMP/traceroute como indisponíveis até existirem workers.',
      ...
      limitation: 'Traceroute exige workers controlados; a API web não executa probes arbitrários de caminho de pacotes.',
      faq: [
        {
          question: 'Por que traceroute aparece indisponível?',
          answer: 'Traceroute precisa de workers controlados e controles antiabuso mais rígidos. O runtime inicial mostra TCP limitado primeiro.',
        },
        {
    ...
    es: {
      ...
      previewResult: 'Latencia y ruta quedan limitadas a probes seguros hasta tener workers.',
      statusLabel: 'API activa',
      ...
      exampleTarget: 'example.com',
      measure: 'El camino actual prueba TCP 443 con timeouts fijos e informa ICMP/traceroute como no disponibles hasta tener workers.',
      ...
      limitation: 'Traceroute requiere workers controlados; la API web no ejecuta probes arbitrarios de ruta de paquetes.',
      faq: [
        {
          question: 'Por qué traceroute aparece no soportado?',
          answer: 'Traceroute necesita workers controlados y controles antiabuso más estrictos. El runtime inicial informa TCP limitado.',
        },
        {
    ...
    fr: {
      ...
      previewResult: 'Latence et chemin restent limités à des probes sûrs jusqu’à disponibilité des workers.',
      statusLabel: 'API active',
      ...
      exampleTarget: 'example.com',
      measure: 'Le chemin actuel teste TCP 443 avec timeouts fixes et signale ICMP/traceroute indisponibles jusqu’aux workers.',
      ...
      limitation: 'Traceroute exige des workers contrôlés; l’API web ne lance pas de probes arbitraires de chemin paquet.',
      faq: [
        {
          question: 'Pourquoi traceroute est-il non supporté ?',
          answer: 'Traceroute demande des workers contrôlés et des contrôles anti-abus plus stricts. Le runtime initial rapporte TCP.',
        },
        {
    ...
    de: {
      ...
      previewResult: 'Latenz und Pfad bleiben auf sichere Probes begrenzt, bis Worker-Infrastruktur verfügbar ist.',
      statusLabel: 'Live-API',
      ...
      exampleTarget: 'example.com',
      measure: 'Der aktuelle Pfad prüft TCP 443 mit festen Timeouts und meldet ICMP/Traceroute als nicht verfügbar, bis Worker existieren.',
      ...
      limitation: 'Traceroute erfordert kontrollierte Worker; die Web-API führt keine beliebigen Paketpfad-Probes aus.',
      faq: [
        {
          question: 'Warum ist Traceroute nicht unterstützt?',
          answer: 'Traceroute benötigt kontrollierte Worker und strengere Abuse-Kontrollen. Die erste Runtime meldet begrenztes TCP zuerst.',
        },
        {

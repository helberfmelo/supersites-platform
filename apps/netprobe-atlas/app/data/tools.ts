...
export const toolCatalog: ToolDefinition[] = [
  {
    ...
    localized: {
      en: {
        ...
        description: 'The foundation page reserves the result layout for the safe API coming in Sprint 2.2.',
        inputLabel: 'Lookup target',
        inputPlaceholder: 'Current connection',
        primaryAction: 'Preview result',
        previewResult: 'The live IP API is gated for Sprint 2.2. No address is collected by this static preview.',
        methodology: [
  ...
  },
  {
    ...
    localized: {
      en: {
        ...
        description: 'The first live API will validate hostnames, cache answers briefly and block unsafe probe shapes.',
        inputLabel: 'Domain name',
        inputPlaceholder: 'example.com',
        primaryAction: 'Preview result',
        previewResult: 'Record rows will show type, value, TTL and resolver notes after the safe DNS API lands.',
        methodology: [

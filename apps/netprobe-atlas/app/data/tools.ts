...
export const toolCatalog: ToolDefinition[] = [
  ...
  makeTool('dns-propagation', 'dns', 'Propagation', {
    en: {
      ...
      statusLabel: 'Ready',
      freeScope: 'A, AAAA, CNAME, MX, NS, PTR, SOA, SRV, TXT and CAA snapshots',
      upgradeScope: 'Scheduled propagation watches and reports',
      exampleTarget: 'example.com',
      measure: 'NetProbe reports each controlled resolver snapshot with locality metadata, returned values and minimum TTL.',
      ...
      limitation: 'Current public coverage is a controlled resolver snapshot, so it should be read with authoritative DNS and TTL timing rather than as a worldwide guarantee.',
      faq: [
        {
          question: 'Is this a worldwide propagation checker?',
          answer: 'It reports the controlled resolver coverage shown in the result matrix. Use the locality labels instead of assuming every region has been queried.',
        },
        {
    ...
    'pt-br': {
      ...
      statusLabel: 'Disponível',
      freeScope: 'Snapshots A, AAAA, CNAME, MX, NS, PTR, SOA, SRV, TXT e CAA',
      upgradeScope: 'Observação agendada de propagação e relatórios',
      exampleTarget: 'example.com',
      measure: 'O NetProbe mostra cada snapshot de resolvedor controlado com localidade, valores retornados e menor TTL.',
      ...
      limitation: 'A cobertura pública atual é um snapshot de resolvedor controlado; leia junto com DNS autoritativo e TTL, não como garantia mundial.',
      faq: [
        {
          question: 'É um verificador mundial de propagação?',
          answer: 'Ele mostra a cobertura controlada exibida na matriz de resultado. Use os rótulos de localidade em vez de presumir consulta em todas as regiões.',
        },
        {
    ...
    es: {
      ...
      statusLabel: 'Disponible',
      freeScope: 'Snapshots A, AAAA, CNAME, MX, NS, PTR, SOA, SRV, TXT y CAA',
      upgradeScope: 'Vigilancia programada de propagación e informes',
      exampleTarget: 'example.com',
      measure: 'NetProbe muestra cada snapshot de resolver controlado con localidad, valores devueltos y TTL mínimo.',
      ...
      limitation: 'La cobertura pública actual es un snapshot de resolver controlado; léelo junto con DNS autoritativo y TTL, no como garantía mundial.',
      faq: [
        {
          question: 'Es un verificador mundial de propagación?',
          answer: 'Muestra la cobertura controlada en la matriz de resultado. Usa las etiquetas de localidad en vez de asumir consulta en todas las regiones.',
        },
        {
    ...
    fr: {
      ...
      statusLabel: 'Disponible',
      freeScope: 'Snapshots A, AAAA, CNAME, MX, NS, PTR, SOA, SRV, TXT et CAA',
      upgradeScope: 'Surveillance planifiée de propagation et rapports',
      exampleTarget: 'example.com',
      measure: 'NetProbe affiche chaque snapshot de résolveur contrôlé avec localité, valeurs retournées et TTL minimum.',
      ...
      limitation: 'La couverture publique actuelle est un snapshot de résolveur contrôlé; lisez-la avec le DNS autoritatif et les TTL, pas comme garantie mondiale.',
      faq: [
        {
          question: 'Est-ce un vérificateur mondial ?',
          answer: 'Il affiche la couverture contrôlée dans la matrice de résultat. Utilisez les libellés de localité au lieu de supposer toutes les régions.',
        },
        {
    ...
    de: {
      ...
      statusLabel: 'Bereit',
      freeScope: 'A-, AAAA-, CNAME-, MX-, NS-, PTR-, SOA-, SRV-, TXT- und CAA-Snapshots',
      upgradeScope: 'Geplante Propagationswatches und Berichte',
      exampleTarget: 'example.com',
      measure: 'NetProbe zeigt jeden kontrollierten Resolver-Snapshot mit Standort, Rückgabewerten und niedrigster TTL.',
      ...
      limitation: 'Die aktuelle öffentliche Abdeckung ist ein kontrollierter Resolver-Snapshot; lesen Sie ihn mit autoritativem DNS und TTL, nicht als weltweite Garantie.',
      faq: [
        {
          question: 'Ist das ein weltweiter Propagation-Checker?',
          answer: 'Er zeigt die kontrollierte Abdeckung in der Ergebnismatrix. Nutzen Sie die Standortlabels, statt alle Regionen anzunehmen.',
        },
        {

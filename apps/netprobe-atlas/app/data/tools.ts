...
export const toolCatalog: ToolDefinition[] = [
  ...
  makeTool('ssl-certificate-checker', 'tls', 'SSL check', {
    en: {
      ...
      fix: 'Check each public edge, renew through the certificate authority and confirm the active certificate after cache or load balancer updates.',
    ...
    'pt-br': {
      ...
      fix: 'Confira cada edge público, renove pela autoridade certificadora e confirme o certificado ativo após cache ou load balancer.',
  ...
  makeTool('dns-propagation', 'dns', 'Propagation', {
    en: {
      ...
      headline: 'Check DNS propagation with a resolver locality matrix, TTLs and distinct answers.',
      description: 'Choose a hostname, record type and optional expected value to compare what the public resolver path returns now.',
      inputLabel: 'Domain name',
      inputPlaceholder: 'example.com',
      primaryAction: 'Run propagation check',
      previewResult: 'Propagation rows show locality, resolver, answer, TTL and whether the expected value matches.',
      statusLabel: 'Ready',
      freeScope: 'A, AAAA, CNAME, MX, NS, PTR, SOA, SRV, TXT and CAA regional checks',
      upgradeScope: 'Scheduled propagation watches and reports',
      exampleTarget: 'example.com',
      measure: 'NetProbe runs regional DNS-over-HTTPS checks with locality hints, returned values and minimum TTL.',
      ...
      limitation: 'Current public coverage uses regional resolver hints, so read it with authoritative DNS and TTL timing rather than as a physical server guarantee for every city.',
      faq: [
        {
          question: 'Is this a worldwide propagation checker?',
          answer: 'It reports the regional DNS-over-HTTPS checks shown in the result matrix. Locality labels come from configured resolver hints, not NetProbe-owned servers in each city.',
        },
        {
    ...
    'pt-br': {
      ...
      headline: 'Cheque propagação DNS com matriz de localidade, TTLs e respostas distintas.',
      description: 'Escolha hostname, tipo de registro e valor esperado opcional para comparar o que o caminho público de resolução retorna agora.',
      inputLabel: 'Nome de domínio',
      inputPlaceholder: 'example.com',
      primaryAction: 'Executar propagação',
      previewResult: 'As linhas mostram localidade, resolvedor, resposta, TTL e se o valor esperado bate.',
      statusLabel: 'Disponível',
      freeScope: 'Consultas regionais A, AAAA, CNAME, MX, NS, PTR, SOA, SRV, TXT e CAA',
      upgradeScope: 'Observação agendada de propagação e relatórios',
      exampleTarget: 'example.com',
      measure: 'O NetProbe executa consultas DNS-over-HTTPS regionais com dicas de localidade, valores retornados e menor TTL.',
      ...
      limitation: 'A cobertura pública atual usa dicas regionais de resolvedor; leia junto com DNS autoritativo e TTL, não como garantia de servidor físico em cada cidade.',
      faq: [
        {
          question: 'É um verificador mundial de propagação?',
          answer: 'Ele mostra as consultas DNS-over-HTTPS regionais exibidas na matriz de resultado. Os rótulos de localidade vêm de dicas configuradas, não de servidores próprios do NetProbe em cada cidade.',
        },
        {
    ...
    es: {
      ...
      headline: 'Comprueba propagación DNS con matriz de localidad, TTLs y respuestas distintas.',
      description: 'Elige hostname, tipo de registro y valor esperado opcional para comparar lo que devuelve ahora la ruta pública de resolución.',
      inputLabel: 'Nombre de dominio',
      inputPlaceholder: 'example.com',
      primaryAction: 'Ejecutar propagación',
      previewResult: 'Las filas muestran localidad, resolver, respuesta, TTL y coincidencia con el valor esperado.',
      statusLabel: 'Disponible',
      freeScope: 'Consultas regionales A, AAAA, CNAME, MX, NS, PTR, SOA, SRV, TXT y CAA',
      upgradeScope: 'Vigilancia programada de propagación e informes',
      exampleTarget: 'example.com',
      measure: 'NetProbe ejecuta consultas DNS-over-HTTPS regionales con pistas de localidad, valores devueltos y TTL mínimo.',
      ...
      limitation: 'La cobertura pública actual usa pistas regionales de resolver; léela junto con DNS autoritativo y TTL, no como garantía de servidor físico en cada ciudad.',
      faq: [
        {
          question: 'Es un verificador mundial de propagación?',
          answer: 'Muestra las consultas DNS-over-HTTPS regionales de la matriz de resultado. Las etiquetas de localidad vienen de pistas configuradas, no de servidores propios de NetProbe en cada ciudad.',
        },
        {
    ...
    fr: {
      ...
      headline: 'Vérifiez la propagation DNS avec matrice de localité, TTL et réponses distinctes.',
      description: 'Choisissez un nom d’hôte, un type et une valeur attendue optionnelle pour comparer la réponse publique actuelle.',
      inputLabel: 'Nom de domaine',
      inputPlaceholder: 'example.com',
      primaryAction: 'Lancer le contrôle de propagation',
      previewResult: 'Les lignes montrent localité, résolveur, réponse, TTL et correspondance avec la valeur attendue.',
      statusLabel: 'Disponible',
      freeScope: 'Contrôles régionaux A, AAAA, CNAME, MX, NS, PTR, SOA, SRV, TXT et CAA',
      upgradeScope: 'Surveillance planifiée de propagation et rapports',
      exampleTarget: 'example.com',
      measure: 'NetProbe exécute des contrôles DNS-over-HTTPS régionaux avec indices de localité, valeurs retournées et TTL minimum.',
      ...
      limitation: 'La couverture publique actuelle utilise des indices régionaux de résolveur; lisez-la avec le DNS autoritatif et les TTL, pas comme garantie de serveur physique dans chaque ville.',
      faq: [
        {
          question: 'Est-ce un vérificateur mondial ?',
          answer: 'Il affiche les contrôles DNS-over-HTTPS régionaux dans la matrice de résultat. Les libellés de localité viennent d’indices configurés, pas de serveurs NetProbe dans chaque ville.',
        },
        {
    ...
    de: {
      navLabel: 'DNS-Propagation',
      title: 'DNS-Propagation',
      headline: 'Prüfen Sie DNS-Propagation mit Standortmatrix, TTLs und unterschiedlichen Antworten.',
      description: 'Wählen Sie Hostname, Eintragstyp und optional erwarteten Wert, um die aktuelle öffentliche Resolver-Antwort zu vergleichen.',
      inputLabel: 'Domainname',
      inputPlaceholder: 'example.com',
      primaryAction: 'Propagation prüfen',
      previewResult: 'Die Zeilen zeigen Standort, Resolver, Antwort, TTL und Abgleich mit dem erwarteten Wert.',
      statusLabel: 'Bereit',
      freeScope: 'Regionale A-, AAAA-, CNAME-, MX-, NS-, PTR-, SOA-, SRV-, TXT- und CAA-Prüfungen',
      upgradeScope: 'Geplante Propagationswatches und Berichte',
      exampleTarget: 'example.com',
      measure: 'NetProbe führt regionale DNS-over-HTTPS-Prüfungen mit Standorthinweisen, Rückgabewerten und niedrigster TTL aus.',
      ...
      limitation: 'Die aktuelle öffentliche Abdeckung nutzt regionale Resolver-Hinweise; lesen Sie sie mit autoritativem DNS und TTL, nicht als Garantie für physische Server in jeder Stadt.',
      faq: [
        {
          question: 'Ist das ein weltweiter Propagation-Checker?',
          answer: 'Er zeigt die regionalen DNS-over-HTTPS-Prüfungen in der Ergebnismatrix. Standortlabels stammen aus konfigurierten Hinweisen, nicht aus NetProbe-eigenen Servern in jeder Stadt.',
        },
        {
      ...
      faq: [
        {
          ...
          answer: 'Traceroute precisa de infraestrutura de probes controlados e controles antiabuso mais rígidos. A consulta pública mostra primeiro o alcance TCP limitado.',
        },
        {
      ...
      faq: [
        {
          ...
          answer: 'Traceroute necesita infraestructura de probes controlados y controles antiabuso más estrictos. La consulta pública informa primero alcance TCP limitado.',
        },
        {

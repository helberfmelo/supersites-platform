  ...
  },
  {
    ...
    localized: {
      en: {
        ...
        description: 'The live lookup summarizes public RDAP facts, omits personal contact data and labels registry limitations.',
        inputLabel: 'Domain name',
        inputPlaceholder: 'example.com',
  ...
  },
  {
    ...
    localized: {
      en: {
        ...
        description: 'The live check validates the hostname, blocks private address ranges and inspects the certificate served on port 443.',
        inputLabel: 'Hostname',
        inputPlaceholder: 'example.com',
  ...
  },
  {
    ...
    localized: {
      en: {
        ...
        description: 'The live check uses the first controlled resolver snapshot and labels the multi-region limitation clearly.',
        inputLabel: 'Domain name',
        inputPlaceholder: 'example.com',
  ...
  },
  {
    ...
    localized: {
      en: {
        ...
        description: 'The live check validates public A/AAAA answers, limits ports to an allowlist and checks at most two public addresses.',
        inputLabel: 'Hostname',
        inputPlaceholder: 'example.com',
  ...
  },
  {
    ...
    localized: {
      en: {
        ...
        description: 'The live check reports bounded TCP reachability first and explains why ICMP/traceroute wait for controlled workers.',
        inputLabel: 'Hostname',
        inputPlaceholder: 'example.com',

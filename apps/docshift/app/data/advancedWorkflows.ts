...
const advancedWorkflowCopy: Record<LocaleCode, DocShiftAdvancedWorkflowCopy> = {
  en: {
    ...
    body: 'OCR, table extraction, Office conversion and server queues need a data matrix before any upload or provider is enabled. The free path remains browser-side.',
    ...
    items: [
      {
        ...
        gate: 'Human approval of OCR provider terms, data transfer, retention, deletion, confidentiality and accuracy disclaimers.',
      },
      {
        title: 'Office and image conversion',
        body: 'DOCX, PPTX, spreadsheet and image conversions need a sandboxed server or approved provider before activation.',
      ...
      },
      {
        ...
        gate: 'Authentication, quotas, signed requests, webhook security, billing entitlement, retention and privacy terms.',
      },
    ],
  },
  'pt-br': {
    title: 'Revisao de workflows documentais avancados',
    body: 'OCR, extracao de tabelas, conversao Office e filas no servidor precisam de matriz de dados antes de qualquer upload ou provider. O caminho gratuito segue no navegador.',
    ...
    items: [
      {
        ...
        gate: 'Aprovacao humana de termos do provider OCR, transferencia, retencao, exclusao, confidencialidade e disclaimers de precisao.',
      },
      {
        title: 'Conversao Office e imagem',
        body: 'Conversoes DOCX, PPTX, planilha e imagem precisam de servidor em sandbox ou provider aprovado antes da ativacao.',
  ...
  es: {
    ...
    body: 'OCR, tablas, conversion Office y colas servidor necesitan matriz de datos antes de cualquier upload o provider. La ruta gratis sigue en el navegador.',
    ...
    items: [
      ...
      },
      {
        ...
        body: 'Conversiones DOCX, PPTX, planillas e imagen requieren servidor sandbox o provider aprobado antes de activarse.',
  ...
  fr: {
    ...
    body: 'OCR, tableaux, conversion Office et queues serveur exigent une matrice donnees avant tout upload ou provider. Le parcours gratuit reste navigateur.',
    ...
    items: [
      ...
      },
      {
        ...
        body: 'Conversions DOCX, PPTX, tableurs et image exigent serveur sandbox ou provider approuve avant activation.',
  ...
  de: {
    ...
    body: 'OCR, Tabellenextraktion, Office-Konvertierung und Server-Queues brauchen eine Datenmatrix vor Upload oder Provider. Der freie Pfad bleibt im Browser.',
    ...
    items: [
      ...
      },
      {
        ...
        body: 'DOCX-, PPTX-, Tabellen- und Bildkonvertierung braucht Sandbox-Server oder genehmigten Provider vor Aktivierung.',

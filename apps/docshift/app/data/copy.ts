...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    gatedTitle: 'Advanced document workflows',
  ...
  'pt-br': {
    ...
    gatedTitle: 'Workflows documentais avancados',
  ...
  es: {
    ...
    gatedTitle: 'Workflows documentales avanzados',
  ...
  fr: {
    ...
    gatedTitle: 'Workflows documentaires avances',
  ...
  de: {
    ...
    gatedTitle: 'Erweiterte Dokument-Workflows',

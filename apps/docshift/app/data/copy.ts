...
export const homeCopy: Record<LocaleCode, HomeCopy> = {
  en: {
    ...
    lead: 'Run useful PDF tools locally without mandatory signup: merge, split, rotate, compress, watermark, page numbers, metadata cleanup and plain text conversion.',
    ...
    principles: [
      ...
      { title: 'Documents stay local', body: 'Selected PDFs are handled with browser memory, local validation and pdf-lib output in the current session.' },
      { title: 'Advanced account boundary', body: 'Batch, larger files, OCR, table extraction, history, API and teams require sandbox, antivirus and retention rules first.' },
    ],
    statusRows: [
  ...
  'pt-br': {
    ...
    lead: 'Use ferramentas uteis de PDF localmente: unir, dividir, girar, comprimir, marca d agua, numeros de pagina, metadados e conversao de texto.',
    ...
    principles: [
      ...
      { title: 'Documentos locais', body: 'PDFs selecionados usam memoria do navegador, validacao local e saida via pdf-lib na sessao.' },
      { title: 'Limite de conta avancada', body: 'Lote, arquivos maiores, OCR, tabelas, historico, API e equipes exigem sandbox, antivirus e retencao antes.' },
    ],
    statusRows: [
  ...
  es: {
    ...
    lead: 'Usa herramientas utiles de PDF localmente: unir, dividir, rotar, comprimir, marca de agua, numeros, metadata y conversion de texto.',
    ...
    principles: [
      ...
      { title: 'Documentos locales', body: 'Los PDFs usan memoria del navegador, validacion local y salida pdf-lib en la sesion.' },
      { title: 'Limite de cuenta avanzada', body: 'Lote, archivos grandes, OCR, tablas, historial, API y equipos requieren sandbox, antivirus y retencion primero.' },
    ],
    statusRows: [
  ...
  fr: {
    ...
    lead: 'Utilisez des outils PDF locaux: fusion, separation, rotation, compression, filigrane, numeros, metadonnees et conversion texte.',
    ...
    principles: [
      ...
      { title: 'Documents locaux', body: 'Les PDFs utilisent memoire navigateur, validation locale et sortie pdf-lib dans la session.' },
      { title: 'Limite compte avance', body: 'Lots, gros fichiers, OCR, tableaux, historique, API et equipes exigent sandbox, antivirus et retention d abord.' },
    ],
    statusRows: [
  ...
  de: {
    ...
    lead: 'Nutzen Sie lokale PDF-Tools: Merge, Split, Rotation, Kompression, Wasserzeichen, Seitennummern, Metadaten und Text-Konvertierung.',
    ...
    principles: [
      ...
      { title: 'Dokumente bleiben lokal', body: 'PDFs nutzen Browser-Speicher, lokale Validierung und pdf-lib-Ausgabe in der Sitzung.' },
      { title: 'Grenze fuer Kontofunktionen', body: 'Batch, grosse Dateien, OCR, Tabellen, Verlauf, API und Teams brauchen zuerst Sandbox, Antivirus und Retention.' },
    ],
    statusRows: [
...
const shellControlCopy: Record<LocaleCode, ShellControlCopy> = {
  en: {
    ...
    localCompressionBody: 'Local compression rewrites PDF structure and metadata. Image downsampling, OCR compression and large-file profiles require reviewed server processing first.',
  ...
  'pt-br': {
    ...
    localCompressionBody: 'A compressao local regrava a estrutura e os metadados do PDF. Reducao de imagens, OCR e perfis para arquivos grandes exigem processamento de servidor revisado primeiro.',
  ...
  es: {
    ...
    localCompressionBody: 'La compresion local reescribe estructura y metadata del PDF. Reduccion de imagenes, OCR y perfiles para archivos grandes requieren procesamiento servidor revisado primero.',
  ...
  fr: {
    ...
    localCompressionBody: 'La compression locale reecrit la structure et les metadonnees du PDF. Reduction image, OCR et profils gros fichiers exigent d abord un traitement serveur revu.',
  ...
  de: {
    ...
    localCompressionBody: 'Lokale Kompression schreibt PDF-Struktur und Metadaten neu. Bildreduktion, OCR und Profile fuer grosse Dateien erfordern zuerst gepruefte Server-Verarbeitung.',
...
export const shellCopy: Record<LocaleCode, ShellCopy> = {
  en: {
    ...
    freeCheckLabel: 'Free document tool',
    ...
    liveBody: 'Local validation and pdf-lib processing run in the browser without mandatory signup.',
    gatedTitle: 'Advanced document features',
    gatedBody: 'Batch, larger files, OCR, table extraction, history, API, teams and server queues need account, privacy and file-safety controls.',
    fileLabel: 'PDF file',
    pagesLabel: 'Pages',
    ...
    workflowSnapshotTitle: 'Process snapshot',
    ...
    fileSafetyBody: 'Server-side batch, OCR, API and history require upload validation, sandboxing, antivirus where applicable, retention and deletion checks.',
    heavyQueueTitle: 'Optional server processing',
    ...
    relatedToolsBody: 'Continue with another local PDF tool without uploading the document.',
  },
  'pt-br': {
    breadcrumbHome: 'DocShift',
    workbenchEyebrow: 'Ferramentas de PDF',
    ...
    freeCheckLabel: 'Ferramenta gratuita',
    ...
    liveBody: 'Validacao local e pdf-lib rodam no navegador sem cadastro obrigatorio.',
    gatedTitle: 'Recursos documentais com conta',
    gatedBody: 'Lotes, arquivos maiores, OCR, tabelas, historico, API, equipes e filas no servidor precisam de controles de conta, privacidade e seguranca de arquivo.',
    ...
    workflowSnapshotTitle: 'Resumo do processo',
    ...
    workerPipelineLabel: 'processamento no navegador + pdf-lib',
    tabPipelineLabel: 'aba do navegador + pdf-lib',
    actualOutputLabel: 'Saida real',
    workerLabel: 'Processamento',
    browserWorkerLabel: 'processamento no navegador',
    ...
    fileSafetyBody: 'Lote server-side, OCR, API e historico exigem validacao de upload, sandbox, antivirus quando aplicavel, retencao e exclusao.',
    heavyQueueTitle: 'Processamento opcional no servidor',
    ...
    relatedToolsBody: 'Continue com outra ferramenta local de PDF sem fazer upload.',
  },
  es: {
    breadcrumbHome: 'DocShift',
    workbenchEyebrow: 'Herramientas PDF',
    ...
    methodologyLabel: 'Metodologia',
    editorialLabel: 'Politica editorial',
    freeCheckLabel: 'Herramienta gratis',
    ...
    liveBody: 'Validacion local y pdf-lib corren en el navegador sin registro obligatorio.',
    gatedTitle: 'Funciones documentales de cuenta',
    gatedBody: 'Lotes, archivos grandes, OCR, tablas, historial, API, equipos y colas servidor necesitan controles de cuenta, privacidad y seguridad de archivo.',
    ...
    workflowSnapshotTitle: 'Resumen del proceso',
    workflowModeLabel: 'Modo',
    workflowInputLabel: 'Entrada',
    ...
    workerPipelineLabel: 'procesamiento en navegador + pdf-lib',
    tabPipelineLabel: 'pestana del navegador + pdf-lib',
    actualOutputLabel: 'Salida real',
    workerLabel: 'Procesamiento',
    browserWorkerLabel: 'procesamiento en navegador',
    localFallbackLabel: 'fallback local',
    ...
    heavyQueueTitle: 'Procesamiento opcional en servidor',
    ...
    relatedToolsBody: 'Continua con otra herramienta PDF local sin subir el documento.',
  },
  fr: {
    breadcrumbHome: 'DocShift',
    workbenchEyebrow: 'Outils PDF',
    ...
    liveBody: 'Validation locale et pdf-lib fonctionnent dans le navigateur sans compte obligatoire.',
    gatedTitle: 'Fonctions documentaires de compte',
    gatedBody: 'Lots, gros fichiers, OCR, tableaux, historique, API, equipes et queues serveur exigent controles de compte, confidentialite et securite fichier.',
    ...
    workflowSnapshotTitle: 'Resume du processus',
    workflowModeLabel: 'Mode',
    ...
    workerPipelineLabel: 'traitement navigateur + pdf-lib',
    tabPipelineLabel: 'onglet navigateur + pdf-lib',
    actualOutputLabel: 'Sortie reelle',
    workerLabel: 'Traitement',
    browserWorkerLabel: 'traitement navigateur',
    localFallbackLabel: 'fallback local',
    ...
    fileSafetyBody: 'Lots serveur, OCR, API et historique exigent validation upload, sandbox, antivirus si applicable, retention et suppression.',
    heavyQueueTitle: 'Traitement serveur optionnel',
    ...
    relatedToolsBody: 'Continuez avec un autre outil PDF local sans upload.',
  },
  de: {
    breadcrumbHome: 'DocShift',
    workbenchEyebrow: 'PDF-Tools',
    ...
    freeCheckLabel: 'Kostenloses Dokumenttool',
    ...
    liveBody: 'Lokale Validierung und pdf-lib laufen im Browser ohne Pflichtkonto.',
    gatedTitle: 'Erweiterte Dokumentfunktionen',
    gatedBody: 'Batch, grosse Dateien, OCR, Tabellen, Verlauf, API, Teams und Server-Queues brauchen Konto-, Datenschutz- und Dateisicherheitskontrollen.',
    fileLabel: 'PDF-Datei',
    pagesLabel: 'Seiten',
    rotationLabel: 'Rotation',
    ...
    workflowSnapshotTitle: 'Prozessschritte',
    ...
    workerPipelineLabel: 'Browser-Verarbeitung + pdf-lib',
    tabPipelineLabel: 'Browser-Tab + pdf-lib',
    actualOutputLabel: 'Tatsaechliche Ausgabe',
    workerLabel: 'Verarbeitung',
    browserWorkerLabel: 'Browser-Verarbeitung',
    ...
    heavyQueueTitle: 'Optionale Server-Verarbeitung',
    ...
    relatedToolsBody: 'Mit einem weiteren lokalen PDF-Tool ohne Upload fortfahren.',
  },
}

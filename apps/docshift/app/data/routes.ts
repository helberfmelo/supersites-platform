...
import { docShiftToolCatalog } from './tools'
import {
...
export const siteBaseUrl = 'https://opentshost.com/supersites/docshift'

export const contentPrerenderRoutes = [
  '/',
  ...publicLocaleCodes.flatMap((locale) => [
    localizedHomePath(locale),
    ...docShiftToolCatalog.map((tool) => localizedToolPath(locale, tool.slug)),

...
const copyByLocale: Record<LocaleCode, {
  ...
  en: {
    ...
    homeBody: 'The free tool stays available without signup. Bookmark this page, share it when useful or send corrections from the contact page.',
    toolBody: 'Use the result first. Support and promotional areas stay separate from the useful result.',
  ...
  'pt-br': {
    ...
    homeBody: 'A ferramenta gratuita continua disponivel sem cadastro. Salve esta pagina, compartilhe quando for util ou envie correcoes pela pagina de contato.',
    toolBody: 'Use o resultado primeiro. Areas de apoio e promocao ficam separadas do resultado util.',
  ...
  es: {
    ...
    homeBody: 'La herramienta gratuita sigue disponible sin registro. Guarda esta pagina, compartela cuando sea util o envia correcciones desde la pagina de contacto.',
    toolBody: 'Usa primero el resultado. Las areas de apoyo y promocion quedan separadas del resultado util.',
  ...
  fr: {
    ...
    homeBody: 'L outil gratuit reste disponible sans compte. Enregistrez cette page, partagez-la s il aide ou envoyez des corrections via la page de contact.',
    toolBody: 'Utilisez d abord le resultat. Les zones de soutien et de promotion restent separees du resultat utile.',
  ...
  de: {
    ...
    homeBody: 'Das kostenlose Tool bleibt ohne Konto verfuegbar. Speichern Sie diese Seite, teilen Sie sie bei Bedarf oder senden Sie Korrekturen ueber die Kontaktseite.',
    toolBody: 'Nutzen Sie zuerst das Ergebnis. Support- und Werbebereiche bleiben vom nuetzlichen Ergebnis getrennt.',

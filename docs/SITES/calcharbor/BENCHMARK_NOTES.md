...
- Local evidence for this stage is intentionally minimal under the current cadence: CalcHarbor unit tests, build, preview smoke, public-copy validation and diff check passed; screenshots/Playwright/crawler/public smokes were not run locally by default.

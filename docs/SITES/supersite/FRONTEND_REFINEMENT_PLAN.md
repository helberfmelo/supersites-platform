...
- Public Status pages must expose only visitor-facing availability, incidents, maintenance, useful checks, contact and scope. Monetization, billing, dry-run, rollback, provider, artifact, release check, crawler evidence and quality-check details belong in admin/docs.

...
- Depois fazer validacao minima, commit objetivo, push e monitorar Quality Gate.
- Deploy/monitoramento HostGator somente quando a etapa exigir publicacao ou quando o owner pedir.
...
- Nao rodar por padrao: screenshots, Playwright/E2E, crawler, Lighthouse/PageSpeed/GTmetrix, deploy dry-run, smokes publicos, todos os package tests, build de todos os apps ou relatorios longos.

...
|---|---:|---|---|
| PROD-ROADMAP | Sprint 8.1 | Roadmap, gates and production rollout documentation | In progress |
| PROD-STATIC-FRAMEWORK | Sprint 8.2 | Generic HostGator static deploy framework for remaining Nuxt apps | Planned |

...
| PROD-CLOSURE | Sprint 8.6 | Public smoke consolidation, docs closure and remaining operations gates | Completed |
...
- Completed technically in production: stale public placeholder wording was corrected in status pages/Hub CTAs, consolidated smokes now reject `noindex`, bootstrap placeholders, stale placeholder wording and ads/tags markers, Hub deploy `28298231558` passed, nine static app redeploys passed and final public smokes passed for Hub/control-plane/API/NetProbe plus all product apps.

...
| 13.2 | DEPTH-TIMENEXUS | Adicionar paginas curadas de cidade/fuso e timeline visual sem geracao ilimitada | Concluida localmente, aguardando fechamento remoto: 8 cidades curadas x 5 idiomas, timeline visual, overlap 09:00, home links, JSON-LD, 11 testes, build/preview/Playwright/public-copy/AdSense-safe/gates locais passaram; sem geracao all-IANA ou calendario/provider externo |

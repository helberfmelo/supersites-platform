...
| Control plane operational tables implemented | 3 |
...
| PixelBatch before/after preview pages | 30 |
| PixelBatch related tool blocks | 30 |
| PixelBatch batch gated panels | 30 |
...
| Sprint 7.3 docs closing commit | `e434ea8` |
| Sprint 7.3 docs-only Quality Gate run | `28286684290` passed |
| Sprint 7.4 local CalcHarbor validation | Passed: Vitest, build, preview smoke, Playwright and screenshot inspection |
| Sprint 7.4 local final gates | Passed: structure, secrets, deploy dry-run, ci:changes and diff check |
| Sprint 7.4 feature commit | `17774eb` |
...
| Sprint 7.5 feature commit | `e006928` |
...
| Sprint 7.6 feature commit | `64b883d` |
...
| Sprint 7.7 docs closing commit | `e9940ec` |
...
| Sprint 7.10 docs closing commit | `408932a` |
...
| Sprint 9.5 NetProbe benchmark UI scope | DNS Propagation tabs/map/table/disclosure plus What is my IP visual panel/privacy CTA/related checks |
| Sprint 9.5 DNS propagation example cleanup | `dns-propagation` localized example target is `example.com`; record type is selected in tabs |
| Sprint 9.5 NetProbe local validation | Passed: `pnpm test:netprobe`, `pnpm build:netprobe`, `pnpm validate:netprobe-preview`, `pnpm test:e2e:netprobe` |
| Sprint 9.5 local preview asset | `/_nuxt/CdSZd5rf.js` validated by `pnpm validate:netprobe-preview` |
...
| Sprint 9.10 MailHealth benchmark UI scope | Unified domain health report on home with SPF, DKIM, DMARC, MX, blacklist, SMTP and optional local headers, 0-100 score, per-check cards, provider-neutral guidance, privacy and antiabuse safeguards |
| Sprint 9.10 MailHealth local validation | Passed: `pnpm test:mailhealth`, `pnpm build:mailhealth`, `pnpm validate:mailhealth-preview`, `pnpm test:e2e:mailhealth` |
| Sprint 9.10 local preview asset | `/_nuxt/BsCQ7iof.js` validated by `pnpm validate:mailhealth-preview` |
...
| Sprint 14.3 local governance gates | Passed: `composer validate --strict`, `validate:structure`, `validate:secrets`, `deploy:dry-run`, `ci:changes`, `git diff --check` |
| Sprint 14.3 feature commit | `2bb673d` |
| Sprint 14.3 remote Quality Gate | `28360245701` passed |
| Sprint 14.3 remote Deploy Dry Run | `28360245696` passed |
| Sprint 14.3 public smokes | Passed: `pnpm deploy:smoke-supersite-public`, `pnpm deploy:smoke-control-plane-public`, `pnpm deploy:smoke-netprobe-public`; Hub asset `https://opentshost.com/supersites/_nuxt/BNDSn3oU.js`; NetProbe asset `https://opentshost.com/supersites/netprobe-atlas/_nuxt/xQOMqDWZ.js` |
| Sprint 14.3 production deploy activation | 0 real deploys triggered in this sprint; public smokes validate the existing production baseline |
...
| Sprint 16.1 feature commit | `2581eab` |
| Sprint 16.1 remote Quality Gate | `28365619891` passed |
| Sprint 16.1 remote Deploy Dry Run | `28365619897` passed |
| Sprint 16.1 public smokes | Passed: `pnpm deploy:smoke-supersite-public`, `pnpm deploy:smoke-control-plane-public`, `pnpm deploy:smoke-netprobe-public`, `pnpm validate:adsense-safe-public`; Hub asset `https://opentshost.com/supersites/_nuxt/BNDSn3oU.js`; NetProbe asset `https://opentshost.com/supersites/netprobe-atlas/_nuxt/xQOMqDWZ.js` |
| Sprint 16.1 production deploy activation | 0 real deploys triggered in this sprint; public smokes validate the existing production baseline |
...
| Sprint 16.2 growth priorities endpoint | `GET /api/v1/growth/priorities` behind auth and `dashboard.view` |
| Sprint 16.2 growth priorities contract | `GrowthPriorityReadiness::CONTRACT_VERSION` `2026-06-29.16.2`; `@supersites/ai-growth growthPriorityContractVersion` |
| Sprint 16.2 default priority queue | 5 seeded recommendations; 5 ready for operator review; 2 human-gated; 0 provider-data-backed priorities; `causality_status=not_inferred` |
...
| Sprint 16.3 growth automation endpoint | `GET /api/v1/growth/automation-readiness` behind auth and `dashboard.view` |
| Sprint 16.3 growth automation contract | `GrowthAutomationReadiness::CONTRACT_VERSION` `2026-06-29.16.3`; `@supersites/ai-growth growthAutomationContractVersion` |
| Sprint 16.3 default automation queue | 5 seeded recommendations; 2 `pr_review_only` candidates; 2 human-gated; 1 blocked by risk threshold; branches 0; PRs 0; auto-merges 0; publications 0 |
| Sprint 16.3 focused validation | Passed: `@supersites/ai-growth` 12 tests; `GrowthAutomationReadinessTest` 4 tests/68 assertions |
| Sprint 16.3 full local validation | Passed: `pnpm test:packages` 88 tests, `pnpm typecheck:packages`, `php artisan test` 90 tests/895 assertions, `composer validate --strict`, `pnpm measure:admin-audit` run `2026-06-29T11-05-06Z`, `pnpm deploy:build-control-plane-hostgator`, `pnpm validate:structure`, `pnpm validate:secrets`, `pnpm deploy:dry-run`, `pnpm ci:changes`, `git diff --check`, `pnpm validate:adsense-safe-public` |
| Sprint 16.3 control-plane artifact | 7164 files, 28345258 bytes, zip 8442691 bytes |
| Sprint 16.3 feature commit | `6a48c31` |
| Sprint 16.3 remote Quality Gate | `28367680725` passed |
| Sprint 16.3 remote Deploy Dry Run | `28367680675` passed |
| Sprint 16.3 public smokes | Passed: `pnpm deploy:smoke-supersite-public`, `pnpm deploy:smoke-control-plane-public`, `pnpm deploy:smoke-netprobe-public`, `pnpm validate:adsense-safe-public`; Hub asset `https://opentshost.com/supersites/_nuxt/BNDSn3oU.js`; NetProbe asset `https://opentshost.com/supersites/netprobe-atlas/_nuxt/xQOMqDWZ.js` |
| Sprint 16.3 production deploy activation | 0 real deploys triggered in this sprint; public smokes validate the existing production baseline |
...
| Sprint 18.13 About route | `/supersites/en/about` converted to institutional public page with mission, network operation, privacy, contact/corrections, languages and responsible growth |
| Sprint 18.13 localized About checks | 5 routes passed: `/supersites/en/about`, `/supersites/pt-br/about`, `/supersites/es/about`, `/supersites/fr/about`, `/supersites/de/about` |
| Sprint 18.13 Hub unit suite | Passed: 25 tests |
| Sprint 18.13 i18n unit suite | Passed: 12 tests |
| Sprint 18.13 Hub build | Passed |
| Sprint 18.13 Hub Playwright suite | Passed: 28 tests, including About desktop EN and mobile PT-BR screenshots |
| Sprint 18.13 About generated HTML check | Passed: 5 locales, required sections present, 0 blocked review/legal-launch phrases |
| Sprint 18.13 AdSense-safe validation | Passed locally and post-deploy: 13 public pages |
| Sprint 18.13 package/structure/secrets/dry-run/diff | Passed, including package tests/typechecks, `ci:changes`, deploy dry-run and `git diff --check` |
| Sprint 18.13 Hub HostGator artifact | Local passed: 211 files, 8704817 bytes; deploy passed: 211 files, 8695818 bytes |
| Sprint 18.13 implementation commit | `398ef0c` |
| Sprint 18.13 remote Quality Gate | `28451195092` passed |
| Sprint 18.13 remote Deploy Dry Run | `28451195046` passed |
| Sprint 18.13 Hub production deploy | `28451482856` passed; release `398ef0c516d6e7348420d1238ce85ac92952155a-28451482856-1`; asset `BQ5vxgN9.js` |
| Sprint 18.13 post-deploy public smoke | Passed: Hub/apps/APIs and 5 About locale routes |
...
| Sprint 18.19 Editorial Policy route | `/supersites/en/editorial-policy` converted to complete localized public editorial policy with useful content, review/updates, corrections, translations, sources/examples and quality standards |
| Sprint 18.19 localized Editorial Policy checks | 5 routes passed: `/supersites/en/editorial-policy`, `/supersites/pt-br/editorial-policy`, `/supersites/es/editorial-policy`, `/supersites/fr/editorial-policy`, `/supersites/de/editorial-policy` |
| Sprint 18.19 Hub unit suite | Passed: 31 tests |
| Sprint 18.19 i18n/consent unit suites | Passed: 12 i18n tests and 8 consent tests |
| Sprint 18.19 Hub build | Passed |
| Sprint 18.19 Hub Playwright suite | Passed: 38 tests, including Editorial Policy desktop EN and mobile PT-BR screenshots |
| Sprint 18.19 Editorial generated HTML check | Passed: 5 locales, required sections and correction mailto present, 0 blocked internal process phrases |
| Sprint 18.19 AdSense-safe validation | Passed locally and post-deploy: 13 public pages |
| Sprint 18.19 package/structure/secrets/dry-run/diff | Passed, including package tests/typechecks, `ci:changes`, deploy dry-run and `git diff --check` |
| Sprint 18.19 Hub HostGator artifact | Local passed: 211 files, 8866334 bytes; production deploy passed: 211 files, 8857335 bytes |
| Sprint 18.19 implementation commit | `e4eb998` |
| Sprint 18.19 remote Quality Gate | `28469279752` passed |
| Sprint 18.19 remote Deploy Dry Run | `28469279691` passed |
| Sprint 18.19 Hub production deploy | `28469514798` passed; release `e4eb99834a4bc587478f7463d877e224e73055f9-28469514798-1`; asset `Vib1iYtU.js` |
| Sprint 18.19 post-deploy public smoke | Passed: Hub/apps/APIs and 5 Editorial Policy locale routes via browser validation |

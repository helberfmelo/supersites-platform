...
| PixelBatch | remove.bg, iLoveIMG, TinyPNG, Squoosh, Photopea, ResizePixel | Public Nuxt SSG live at `/supersites/pixelbatch/`; Sprint 9.8 production workbench adds dense image tabs, drag-and-drop, use-case presets and before/after savings metrics | Dropzone plus before/after preview and privacy clarity | 9.8 | Dominant drag-and-drop image workflow with before/after metrics |
